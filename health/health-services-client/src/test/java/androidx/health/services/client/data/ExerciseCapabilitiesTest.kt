...
class ExerciseCapabilitiesTest {
    ...
    fun return_supportedDataTypesForSpecifiedExercise() {
        assertThat(
                EXERCISE_CAPABILITIES.getExerciseTypeCapabilities(ExerciseType.WALKING)
                    .supportedDataTypes
            )
            .containsExactly(DataType.STEPS)
    }

    @Test
    fun supportedGoalsForExercise() {
        assertThat(
                EXERCISE_CAPABILITIES.getExerciseTypeCapabilities(ExerciseType.RUNNING)
                    .supportedGoals
            )
            .isEqualTo(
    ...
    fun supportedMilestonesForExercise() {
        assertThat(
            ...
            .isEqualTo(
                EXERCISE_CAPABILITIES.typeToCapabilities
    ...
    fun supportedExerciseEventForGolfExercise() {
        assertThat(
                EXERCISE_CAPABILITIES.getExerciseTypeCapabilities(ExerciseType.GOLF)
        ...
        assertThat(
            ...
            .isEqualTo(
                EXERCISE_CAPABILITIES.typeToCapabilities
                    .get(ExerciseType.GOLF)
                    ?.supportedExerciseEvents
            )
        assertThat(
                EXERCISE_CAPABILITIES.typeToCapabilities[ExerciseType.GOLF]
    ...
    fun exercisesSupportingAutoResumeAndPause_returnCorrectSet() {
        val supportsAutoPauseAndResume =
        ...
        val doesNotSupportAutoPauseAndResume =
            ExerciseTypeCapabilities(
                supportedDataTypes = ImmutableSet.of(),
                supportedGoals = ImmutableMap.of(),
                supportedMilestones = ImmutableMap.of(),
    ...
    fun parcelable_roundTrip_returnsOriginalCapabilities() {
        ...
        assertThat(capabilities.supportedExerciseTypes)
            .containsExactlyElementsIn(EXERCISE_CAPABILITIES.supportedExerciseTypes)
        assertThat(capabilities.autoPauseAndResumeEnabledExercises)
            .containsExactlyElementsIn(EXERCISE_CAPABILITIES.autoPauseAndResumeEnabledExercises)
        assertThat(capabilities.supportedBatchingModeOverrides)
            .containsExactlyElementsIn(EXERCISE_CAPABILITIES.supportedBatchingModeOverrides)
    }
    ...
    fun parcelable_roundTrip_returnsEmptyOriginalCapabilities() {
        ...
        assertThat(emptyCapabilities.supportedExerciseTypes)
            .containsExactlyElementsIn(roundTripEmptyCapabilities.supportedExerciseTypes)
        assertThat(emptyCapabilities.autoPauseAndResumeEnabledExercises)
            .containsExactlyElementsIn(
                roundTripEmptyCapabilities.autoPauseAndResumeEnabledExercises
            )
        assertThat(emptyCapabilities.supportedBatchingModeOverrides)
            .containsExactlyElementsIn(roundTripEmptyCapabilities.supportedBatchingModeOverrides)
    }

    companion object {
        private val WALKING_CAPABILITIES =
            ExerciseTypeCapabilities(
        ...
        private val RUNNING_CAPABILITIES =
            ExerciseTypeCapabilities(
        ...
        private val SWIMMING_CAPABILITIES =
            ExerciseTypeCapabilities(
