...
/** Wrapper to convert [IUpdateDataCallback] to listenable futures. */
internal class UpdateDataCallback(private val resultFuture: SettableFuture<Unit>) :
    IUpdateDataCallback.Stub() {
