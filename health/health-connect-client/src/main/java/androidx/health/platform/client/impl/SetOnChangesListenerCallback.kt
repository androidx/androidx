...
/** Wrapper to convert [ISetOnChangesListenerCallback] to listenable futures. */
internal class SetOnChangesListenerCallback(private val resultFuture: SettableFuture<Unit>) :
    ISetOnChangesListenerCallback.Stub() {
