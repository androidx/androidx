...
public class Energy private constructor(private val value: Double, private val type: Type) :
    ...
    public companion object {
        ...
        @JvmStatic public fun calories(value: Double): Energy = Energy(value, Type.CALORIES)

        /** Creates [Energy] with the specified value in kilocalories. */
        @JvmStatic public fun kilocalories(value: Double): Energy = Energy(value, Type.KILOCALORIES)

        /** Creates [Energy] with the specified value in joules. */
        @JvmStatic public fun joules(value: Double): Energy = Energy(value, Type.JOULES)

        /** Creates [Energy] with the specified value in kilojoules. */
        @JvmStatic public fun kilojoules(value: Double): Energy = Energy(value, Type.KILOJOULES)
    }
...
/** Creates [Energy] with the specified value in calories. */
@get:JvmSynthetic
public val Double.calories: Energy
    get() = Energy.calories(value = this)

/** Creates [Energy] with the specified value in calories. */
@get:JvmSynthetic
public val Long.calories: Energy
    get() = toDouble().calories

/** Creates [Energy] with the specified value in calories. */
@get:JvmSynthetic
public val Float.calories: Energy
    get() = toDouble().calories

/** Creates [Energy] with the specified value in calories. */
@get:JvmSynthetic
public val Int.calories: Energy
    get() = toDouble().calories

/** Creates [Energy] with the specified value in kilocalories. */
@get:JvmSynthetic
public val Double.kilocalories: Energy
    get() = Energy.kilocalories(value = this)

/** Creates [Energy] with the specified value in kilocalories. */
@get:JvmSynthetic
public val Long.kilocalories: Energy
    get() = toDouble().kilocalories

/** Creates [Energy] with the specified value in kilocalories. */
@get:JvmSynthetic
public val Float.kilocalories: Energy
    get() = toDouble().kilocalories

/** Creates [Energy] with the specified value in kilocalories. */
@get:JvmSynthetic
public val Int.kilocalories: Energy
    get() = toDouble().kilocalories

/** Creates [Energy] with the specified value in joules. */
@get:JvmSynthetic
public val Double.joules: Energy
    get() = Energy.joules(value = this)

/** Creates [Energy] with the specified value in joules. */
@get:JvmSynthetic
public val Long.joules: Energy
    get() = toDouble().joules

/** Creates [Energy] with the specified value in joules. */
@get:JvmSynthetic
public val Float.joules: Energy
    get() = toDouble().joules

/** Creates [Energy] with the specified value in joules. */
@get:JvmSynthetic
public val Int.joules: Energy
    get() = toDouble().joules

/** Creates [Energy] with the specified value in kilojoules. */
@get:JvmSynthetic
public val Double.kilojoules: Energy
    get() = Energy.kilojoules(value = this)

/** Creates [Energy] with the specified value in kilojoules. */
@get:JvmSynthetic
public val Long.kilojoules: Energy
    get() = toDouble().kilojoules

/** Creates [Energy] with the specified value in kilojoules. */
@get:JvmSynthetic
public val Float.kilojoules: Energy
    get() = toDouble().kilojoules

/** Creates [Energy] with the specified value in kilojoules. */
@get:JvmSynthetic
public val Int.kilojoules: Energy
    get() = toDouble().kilojoules
