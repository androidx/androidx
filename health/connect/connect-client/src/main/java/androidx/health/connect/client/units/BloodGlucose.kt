 ...
 */
public class BloodGlucose private constructor(private val value: Double, private val type: Type) :
    Comparable<BloodGlucose> {

    /** Returns the blood glucose level in mmol/L. */
    @get:JvmName("getMillimolesPerLiter")
    public val inMillimolesPerLiter: Double
    ...
    public val inMilligramsPerDeciliter: Double
    ...
    public companion object {
        ...
        @JvmStatic
        public fun millimolesPerLiter(value: Double): BloodGlucose =
            BloodGlucose(value, Type.MILLIMOLES_PER_LITER)

        /** Creates [BloodGlucose] with the specified value in mg/dL. */
        @JvmStatic
        public fun milligramsPerDeciliter(value: Double): BloodGlucose =
