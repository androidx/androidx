 ...
 *   filter.
 */
public class ChangesTokenRequest(
    @get:RestrictTo(RestrictTo.Scope.LIBRARY_GROUP) public val recordTypes: Set<KClass<out Record>>,
    @get:RestrictTo(RestrictTo.Scope.LIBRARY_GROUP)
    public val dataOriginFilters: Set<DataOrigin> = setOf(),
) {
    /*
