...
internal class GetChangesTokenCallback(
    private val resultFuture: SettableFuture<ResponseProto.GetChangesTokenResponse>
) : IGetChangesTokenCallback.Stub() {

    override fun onSuccess(response: GetChangesTokenResponse) {
