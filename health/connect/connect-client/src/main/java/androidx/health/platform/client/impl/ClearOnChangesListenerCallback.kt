...
/** Wrapper to convert [IClearOnChangesListenerCallback] to listenable futures. */
internal class ClearOnChangesListenerCallback(private val resultFuture: SettableFuture<Unit>) :
    IClearOnChangesListenerCallback.Stub() {
