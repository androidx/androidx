...
public class BloodGlucoseRecord(
    ...
    public companion object {
        ...
        public const val RELATION_TO_MEAL_UNKNOWN: Int = 0
        public const val RELATION_TO_MEAL_GENERAL: Int = 1
        public const val RELATION_TO_MEAL_FASTING: Int = 2
        public const val RELATION_TO_MEAL_BEFORE_MEAL: Int = 3
        public const val RELATION_TO_MEAL_AFTER_MEAL: Int = 4

        public const val SPECIMEN_SOURCE_UNKNOWN: Int = 0
        public const val SPECIMEN_SOURCE_INTERSTITIAL_FLUID: Int = 1
        public const val SPECIMEN_SOURCE_CAPILLARY_BLOOD: Int = 2
        public const val SPECIMEN_SOURCE_PLASMA: Int = 3
        public const val SPECIMEN_SOURCE_SERUM: Int = 4
        public const val SPECIMEN_SOURCE_TEARS: Int = 5
        public const val SPECIMEN_SOURCE_WHOLE_BLOOD: Int = 6

        @RestrictTo(RestrictTo.Scope.LIBRARY)
        @JvmField
        public val RELATION_TO_MEAL_STRING_TO_INT_MAP: Map<String, Int> =
            mapOf(
        ...
        @RestrictTo(RestrictTo.Scope.LIBRARY)
        @JvmField
        public val RELATION_TO_MEAL_INT_TO_STRING_MAP: Map<Int, String> =
            RELATION_TO_MEAL_STRING_TO_INT_MAP.reverse()

        @RestrictTo(RestrictTo.Scope.LIBRARY)
        @JvmField
        public val SPECIMEN_SOURCE_STRING_TO_INT_MAP: Map<String, Int> =
            mapOf(
        ...
        @RestrictTo(RestrictTo.Scope.LIBRARY)
        @JvmField
        public val SPECIMEN_SOURCE_INT_TO_STRING_MAP: Map<Int, String> =
            SPECIMEN_SOURCE_STRING_TO_INT_MAP.reverse()
    }
    ...
    @RestrictTo(RestrictTo.Scope.LIBRARY)
    public annotation class SpecimenSources
    ...
    public annotation class RelationToMeals
