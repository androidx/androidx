...
/** Wrapper to convert [IDeleteDataCallback] to listenable futures. */
internal class DeleteDataCallback(private val resultFuture: SettableFuture<Unit>) :
    IDeleteDataCallback.Stub() {
