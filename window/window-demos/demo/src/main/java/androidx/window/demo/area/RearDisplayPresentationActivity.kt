 ...
 * operation on a [WindowArea] of type [TYPE_REAR_FACING] as well as enabling/disabling a
...
class RearDisplayPresentationActivity :
    ...
    private var currentWindowArea: WindowArea? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.rearDisplayPresentationButton.setOnClickListener {
            if (activePresentation != null) {
                ...
                currentWindowArea?.let { windowArea ->
    ...
    override fun onStart() {
        super.onStart()
        windowAreaController.addWindowAreasListener(Runnable::run, windowAreaListener)
    }
    ...
    private fun updateRearDisplayPresentationButton() {
        ...
        when (currentWindowArea?.getCapability(OPERATION_PRESENT_ON_AREA)?.status) {
