...
/**
 * This file defines the Vendor API Level 1 Requirements for WindowAreaComponent to support rear
 * display presentation only. This is used in the client library to perform reflection guard to
 * ensure that the OEM extension implementation is complete.
 *
