...
internal class SplitPlaceHolderRuleTest {
    ...
    /*------------------------------Builder Test------------------------------*/
    /**
     * Verifies that default params are set correctly when creating [SplitPlaceholderRule] with a
     * builder.
     */
    @Test
    ...
    fun test_SplitPlaceholderRule_Builder() {
        ...
        filters.add(ActivityFilter(ComponentName("a", "b"), "ACTION"))
    ...
    /**
     * Verifies that illegal parameter values are not allowed when creating [SplitPlaceholderRule]
     * with a builder.
     */
    @Test
    ...
    fun testToString() {
        ...
        val expectedSplitAttributes =
            SplitAttributes.Builder()
                ...
                .setLayoutDirection(SplitAttributes.LayoutDirection.LEFT_TO_RIGHT)
                .build()
        filters.add(ActivityFilter(ActivityComponentInfo("a", "b"), "ACTION"))
        val ruleString =
            SplitPlaceholderRule.Builder(filters, intent)
