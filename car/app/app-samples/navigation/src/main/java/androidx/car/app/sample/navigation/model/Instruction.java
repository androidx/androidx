...
public class Instruction {
    ...
    public static final class Builder {
        ...
        @Nullable Destination mDestination;
        @Nullable Step mStep;
        @Nullable Distance mStepRemainingDistance;
        @Nullable TravelEstimate mStepTravelEstimate;
        @Nullable TravelEstimate mDestinationTravelEstimate;
        @Nullable String mRoad;
        boolean mShouldShowNextStep;
        boolean mShouldShowLanes;
        @Nullable CarIcon mJunctionImage;

        @Nullable String mNotificationTitle;
        @Nullable String mNotificationContent;
