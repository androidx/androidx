...
public class SeekbarListItem extends ListItem<SeekbarListItem.ViewHolder> {
    ...
    public static class Builder {
        ...
        public Builder withDividerHidden() {
            ...
            /**
             * Adds {@code ViewBinder} to interact with sub-views in
             * {@link ViewHolder}. These view binders will always be applied after
             * other {@link Builder} methods are called.
             *
