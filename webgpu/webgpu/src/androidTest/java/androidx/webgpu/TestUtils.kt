...
public suspend fun <T : Throwable> assertThrowsSuspend(
    ...
    throw AssertionError(
        "Expected exception of type ${expectedThrowable.name} but no exception was thrown"
    )
}
...
public suspend fun <T : Throwable> assertThrowsSuspend(
    ...
    throw AssertionError(
        "$message: Expected exception of type ${expectedThrowable.name} but no exception was thrown"
    )
}
