...
/**
 * Base abstract wrapper for imported hardware buffers. Manages the native handle and
 * synchronization fences for accessing the buffer.
 */
@ExperimentalWebGpuApi
public abstract class GPUHardwareBufferWrapper(private val handle: Long) : AutoCloseable {
