...
public class GPUSampler private constructor(public val handle: Long) : AutoCloseable {
    /**
     * Sets a debug label for the sampler.
     *
     * @param label The label to assign to the sampler.
     */
    @FastNative @JvmName("setLabel") public external fun setLabel(label: String): Unit

    external override fun close()

    override fun equals(other: Any?): Boolean = other is GPUSampler && other.handle == handle
