...
public class GPUSyncFence
internal constructor(private val parcelFileDescriptor: ParcelFileDescriptor) : AutoCloseable {
    ...
    private external fun awaitParcelFileDescriptorNative(
        pfd: ParcelFileDescriptor,
        timeoutMillis: Long,
    ): Boolean

    /**
     * Extracts the ParcelFileDescriptor. This is intended for internal library use or when passing
     * to JNI.
     */
