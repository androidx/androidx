...
/**
 * Helpers for image dimension management. Each adds a method to round to the next higher or lower
 * multiple of a value, e.g., "round -1,234 down to the nearest multiple of 1,000" returns -2000.
 */
