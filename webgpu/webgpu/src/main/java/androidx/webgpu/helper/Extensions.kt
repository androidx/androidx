 ...
 *
 * Safely handles API level compatibility internally. On devices below Android T (API 33), this
 * function will safely return `null` without requiring API version checks at the call site.
 */
