...
public class GPURenderPipeline private constructor(public val handle: Long) : AutoCloseable {
    /**
     ...
     *
     * @param label The label to assign to the render pipeline.
     */
    @FastNative @JvmName("setLabel") public external fun setLabel(label: String): Unit

    external override fun close()

    override fun equals(other: Any?): Boolean = other is GPURenderPipeline && other.handle == handle
