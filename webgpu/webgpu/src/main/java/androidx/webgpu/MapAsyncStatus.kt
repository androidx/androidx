...
public annotation class MapAsyncStatus {
    public companion object {
        ...
        /**
         * Indicates the buffer mapping operation was cancelled. This commonly happens if the buffer
         * is unmapped or destroyed before the asynchronous map request completes.
         */
