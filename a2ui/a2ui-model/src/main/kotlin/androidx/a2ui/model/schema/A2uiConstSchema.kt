...
public class A2uiConstSchema(
    ...
    override fun toString(): String {
        return "Const(value=$value, description=$description)"
    }

    internal companion object {
        internal const val KEY_CONST = "const"
    }
}
