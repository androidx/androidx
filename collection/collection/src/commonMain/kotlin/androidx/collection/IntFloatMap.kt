...
public fun intFloatMapOf(key1: Int, value1: Float): IntFloatMap =
    MutableIntFloatMap().also { map -> map[key1] = value1 }
...
/**
 * Returns a new [IntFloatMap] with [key1], [key2], and [key3] associated with [value1], [value2],
...
/**
 * Returns a new [IntFloatMap] with [key1], [key2], [key3], and [key4] associated with [value1],
...
/**
 * Returns a new [IntFloatMap] with [key1], [key2], [key3], [key4], and [key5] associated with
...
public fun mutableIntFloatMapOf(key1: Int, value1: Float): MutableIntFloatMap =
    MutableIntFloatMap().also { map -> map[key1] = value1 }

/**
 * Returns a new [MutableIntFloatMap] with [key1], and [key2] associated with [value1], and
 * [value2], respectively.
 */
...
/**
 * Returns a new [MutableIntFloatMap] with [key1], [key2], and [key3] associated with [value1],
...
/**
 * Returns a new [MutableIntFloatMap] with [key1], [key2], [key3], and [key4] associated with
...
/**
 * Returns a new [MutableIntFloatMap] with [key1], [key2], [key3], [key4], and [key5] associated
 ...
 * provided by [MutableIntFloatMap].
 *
...
/**
 * [MutableIntFloatMap] is a container with a [MutableMap]-like interface for [Int] primitive keys
 ...
 */
public class MutableIntFloatMap(initialCapacity: Int = DefaultScatterCapacity) : IntFloatMap() {
    ...
    /**
     * Trims this [MutableIntFloatMap]'s storage so it is sized appropriately to hold the current
     * mappings.
     *
