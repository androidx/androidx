...
public fun longLongMapOf(key1: Long, value1: Long): LongLongMap =
    MutableLongLongMap().also { map -> map[key1] = value1 }

/**
 * Returns a new [LongLongMap] with [key1], and [key2] associated with [value1], and [value2],
 * respectively.
 */
public fun longLongMapOf(key1: Long, value1: Long, key2: Long, value2: Long): LongLongMap =
    MutableLongLongMap().also { map ->
        map[key1] = value1
        map[key2] = value2
    }

/**
 * Returns a new [LongLongMap] with [key1], [key2], and [key3] associated with [value1], [value2],
...
/**
 * Returns a new [LongLongMap] with [key1], [key2], [key3], and [key4] associated with [value1],
...
/**
 * Returns a new [LongLongMap] with [key1], [key2], [key3], [key4], and [key5] associated with
...
public fun mutableLongLongMapOf(key1: Long, value1: Long): MutableLongLongMap =
    MutableLongLongMap().also { map -> map[key1] = value1 }

/**
 * Returns a new [MutableLongLongMap] with [key1], and [key2] associated with [value1], and
 * [value2], respectively.
 */
...
/**
 * Returns a new [MutableLongLongMap] with [key1], [key2], and [key3] associated with [value1],
...
/**
 * Returns a new [MutableLongLongMap] with [key1], [key2], [key3], and [key4] associated with
...
/**
 * Returns a new [MutableLongLongMap] with [key1], [key2], [key3], [key4], and [key5] associated
 ...
 */
public inline fun buildLongLongMap(builderAction: MutableLongLongMap.() -> Unit): LongLongMap {
 ...
 * provided by [MutableLongLongMap].
 *
...
/**
 * [MutableLongLongMap] is a container with a [MutableMap]-like interface for [Long] primitive keys
 ...
 */
public class MutableLongLongMap(initialCapacity: Int = DefaultScatterCapacity) : LongLongMap() {
    ...
    /**
     * Trims this [MutableLongLongMap]'s storage so it is sized appropriately to hold the current
     * mappings.
     *
