...
class StorageNotLowTracker(context: Context, taskExecutor: TaskExecutor) :
    ...
    override val intentFilter: IntentFilter
        get() {
            ...
            // manifest-defined BroadcastReceivers. Since we are registering our receiver manually,
            // this
            // is currently okay. This may change in future versions, so this will need to be
            // monitored.
