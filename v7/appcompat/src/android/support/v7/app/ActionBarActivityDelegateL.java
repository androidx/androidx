...
class ActionBarActivityDelegateL extends ActionBarActivityDelegate {

    private Menu mMenu;

    ActionBarActivityDelegateL(ActionBarActivity activity) {
        super(activity);
    }

    @Override
    public ActionBar createSupportActionBar() {
        return new ActionBarImplL(mActivity, mActivity);
    }
    ...
    public View onCreatePanelView(int featureId) {
        // Do not create custom options menu on L+
        return null;
    }
    ...
    class WindowCallbackWrapper implements Window.Callback {
        ...
        public void onActionModeStarted(android.view.ActionMode mode) {
            ...
            ActionBarActivityDelegateL.this.onActionModeStarted(mode);
        }

        @Override
        public void onActionModeFinished(android.view.ActionMode mode) {
            mWrapped.onActionModeFinished(mode);
            ActionBarActivityDelegateL.this.onActionModeFinished(mode);
        }
    }
}
