    ...
    class AppCompatWindowCallbackV14 extends WindowCallbackWrapper {
        ...
        public boolean dispatchKeyShortcutEvent(KeyEvent event) {
            return super.dispatchKeyShortcutEvent(event)
                    || AppCompatDelegateImplV9.this.onKeyShortcut(event.getKeyCode(), event);
        }
        ...
        public boolean onMenuOpened(int featureId, Menu menu) {
            ...
            AppCompatDelegateImplV9.this.onMenuOpened(featureId);
            return true;
        }
        ...
        public void onPanelClosed(int featureId, Menu menu) {
            ...
            AppCompatDelegateImplV9.this.onPanelClosed(featureId);
        }
