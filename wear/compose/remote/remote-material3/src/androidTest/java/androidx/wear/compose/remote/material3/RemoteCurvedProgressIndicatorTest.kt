...
class RemoteCurvedProgressIndicatorTest {
    ...
    private val creationDisplayInfo = createCreationDisplayInfo(context, Size(400f, 400f))
    ...
    fun indicator_enabled_rtl() {
        remoteComposeTestRule.runScreenshotTest(
            ...
            ComponentContainer { RemoteCurvedProgressEnabledRtl() }
        }
    }
    ...
    fun indicator_customEndAngle_and_noGap() {
        remoteComposeTestRule.runScreenshotTest(remoteCreationDisplayInfo = creationDisplayInfo) {
            ComponentContainer { RemoteCurvedProgressNoGap() }
        }
    }
    ...
    fun indicator_disabled() {
        remoteComposeTestRule.runScreenshotTest(remoteCreationDisplayInfo = creationDisplayInfo) {
            ComponentContainer { RemoteCurvedProgressIndicatorDisabled() }
        }
    }
    ...
    fun indicator_customColors() {
        remoteComposeTestRule.runScreenshotTest(remoteCreationDisplayInfo = creationDisplayInfo) {
            ComponentContainer { RemoteCurvedProgressIndicatorCustomColor() }
        }
    }
