...
import androidx.wear.compose.remote.material3.previews.RemoteSplitSwitchButtonUnchecked
import androidx.wear.compose.remote.material3.previews.RemoteSplitSwitchButtonWithSecondaryLabel
import androidx.wear.compose.remote.material3.samples.RemoteSplitSwitchButtonSample
import androidx.wear.compose.ui.tooling.preview.WearPreviewDevices

@Composable
fun RemoteSplitSwitchButtonDemos(modifier: Modifier = Modifier) {
        ...
        TransformingLazyColumn(state = columnState, contentPadding = contentPadding) {
            item {
                ListHeader(
                    ...
                    Text(
                        "RemoteSplitSwitchButton Demos",
                        modifier = Modifier.fillMaxWidth(),
                        textAlign = TextAlign.Center,
                    )
                }
            }
            remoteDemoItem("Checked") { RemoteSplitSwitchButtonChecked() }
            remoteDemoItem("Unchecked") { RemoteSplitSwitchButtonUnchecked() }
            remoteDemoItem("Disabled Checked") { RemoteSplitSwitchButtonDisabledChecked() }
...
@WearPreviewDevices
@Composable
private fun RemoteSplitSwitchButtonDemosPreview() {
