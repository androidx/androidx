...
import androidx.wear.compose.remote.material3.samples.RemoteSwitchButtonSample
import androidx.wear.compose.ui.tooling.preview.WearPreviewDevices

@Composable
fun RemoteSwitchButtonDemos(modifier: Modifier = Modifier) {
        ...
        TransformingLazyColumn(state = columnState, contentPadding = contentPadding) {
            item {
                ListHeader(
                    ...
                    Text(
                        "RemoteSwitchButton Demos",
                        modifier = Modifier.fillMaxWidth(),
                        textAlign = TextAlign.Center,
                    )
                }
            }
            remoteDemoItem("Checked") { RemoteSwitchButtonChecked() }
            remoteDemoItem("Unchecked") { RemoteSwitchButtonUnchecked() }
            remoteDemoItem("Disabled Checked") { RemoteSwitchButtonDisabledChecked() }
            remoteDemoItem("Disabled Unchecked") { RemoteSwitchButtonDisabledUnchecked() }
...
@WearPreviewDevices
@Composable
private fun RemoteSwitchButtonDemosPreview() {
