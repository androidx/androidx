...
/** [IssueRegistry] containing Wear Remote Compose specific lint issues. */
class WearRemoteIssueRegistry : IssueRegistry() {
    override val api = 16
    ...
    override val vendor =
        Vendor(
            vendorName = "Jetpack Wear Compose Remote",
            identifier = "androidx.wear.compose.remote",
