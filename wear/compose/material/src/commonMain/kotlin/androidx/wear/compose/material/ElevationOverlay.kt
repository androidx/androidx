 ...
 * used to emphasize elevation in dark themes, where shadows are not as visible. An
...
private object DefaultElevationOverlay : ElevationOverlay {
    ...
    override fun apply(color: Color, elevation: Dp): Color {
        // For Wear themes, always apply the elevation -
        // unlike Material, which ignores it in Light theme.
