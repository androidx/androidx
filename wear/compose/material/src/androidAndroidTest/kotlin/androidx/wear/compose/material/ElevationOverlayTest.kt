...
// Wear Material omits the following Material ElevationOverlayTest test cases:
// 1) correctElevationOverlayWithCustomContentColor - Wear Material Theme does not allow
//    overrides of onSurface or onBackground and this test relies on customizing those colors on the
//    theme and ensuring that they are used for calculate a new foreground overlay.
// 2) noChangesInLightTheme - Wear Material Theme does not have a lightColors variation.
@LargeTest
...
class ElevationOverlayTest(private val elevation: Dp?, overlayAlpha: Float?) {
    ...
    @Test
    fun correctElevationOverlay_withParentSurface() {
        var colors = Colors()
