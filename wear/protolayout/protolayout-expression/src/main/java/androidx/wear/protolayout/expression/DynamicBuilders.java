...
public final class DynamicBuilders {
    ...
    public interface DynamicInt32 extends DynamicType {
         ...
         * This will use the value given in either {@link ConditionScope#use(DynamicType)} or
         * {@link ConditionScopes.IfTrueScope#elseUse(DynamicType)} depending on the value yielded
         * from {@code condition}.
         */
        @RequiresSchemaVersion(major = 1, minor = 200)
    ...
    public interface DynamicString extends DynamicType {
        ...
        /**
         * Equivalent of {@link String#format(String, Object...)} but supports {@link DynamicType}s,
         * and returns a {@link DynamicString}.
         *
         ...
         * It will use the value given in either {@link ConditionScope#use(DynamicType)} or {@link
         * ConditionScopes.IfTrueScope#elseUse(DynamicType)} depending on the value yielded from
         * {@code condition}.
         *
    ...
    public interface DynamicColor extends DynamicType {
         ...
         * This will use the value given in either {@link ConditionScope#use(DynamicType)} or {@link
         * ConditionScopes.IfTrueScope#elseUse(DynamicType)} depending on the value yielded from
         * {@code condition}.
         */
        @RequiresSchemaVersion(major = 1, minor = 200)
