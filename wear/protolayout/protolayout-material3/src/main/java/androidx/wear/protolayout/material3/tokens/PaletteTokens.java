...
public final class PaletteTokens {
    @ColorInt
    public static final int ERROR0 = Color.rgb(/* red= */ 0, /* green= */ 0, /* blue= */ 0);
    ...
    @ColorInt
    public static final int NEUTRAL100 =
    ...
    @ColorInt
    public static final int NEUTRAL50 =
            Color.rgb(/* red= */ 122, /* green= */ 116, /* blue= */ 132);

    @ColorInt
    public static final int NEUTRAL60 =
            Color.rgb(/* red= */ 148, /* green= */ 142, /* blue= */ 159);

    @ColorInt
    public static final int NEUTRAL70 =
            Color.rgb(/* red= */ 175, /* green= */ 168, /* blue= */ 185);

    @ColorInt
    public static final int NEUTRAL80 =
            Color.rgb(/* red= */ 203, /* green= */ 195, /* blue= */ 213);

    @ColorInt
    public static final int NEUTRAL90 =
            Color.rgb(/* red= */ 232, /* green= */ 223, /* blue= */ 242);

    @ColorInt
    public static final int NEUTRAL95 =
            Color.rgb(/* red= */ 246, /* green= */ 237, /* blue= */ 255);

    @ColorInt
    public static final int NEUTRAL_VARIANT0 =
    ...
    @ColorInt
    public static final int PRIMARY100 =
            Color.rgb(/* red= */ 255, /* green= */ 255, /* blue= */ 255);
    ...
    @ColorInt
    public static final int PRIMARY50 =
            Color.rgb(/* red= */ 127, /* green= */ 109, /* blue= */ 170);

    @ColorInt
    public static final int PRIMARY60 =
            Color.rgb(/* red= */ 153, /* green= */ 135, /* blue= */ 198);

    @ColorInt
    public static final int PRIMARY70 =
            Color.rgb(/* red= */ 180, /* green= */ 161, /* blue= */ 226);

    @ColorInt
    public static final int PRIMARY80 =
            Color.rgb(/* red= */ 208, /* green= */ 188, /* blue= */ 255);

    @ColorInt
    public static final int PRIMARY90 =
            Color.rgb(/* red= */ 233, /* green= */ 221, /* blue= */ 255);

    @ColorInt
    public static final int PRIMARY95 =
            Color.rgb(/* red= */ 246, /* green= */ 237, /* blue= */ 255);
    ...
    @ColorInt
    public static final int SECONDARY40 =
            Color.rgb(/* red= */ 98, /* green= */ 90, /* blue= */ 116);
    ...
    @ColorInt
    public static final int TERTIARY50 =
            Color.rgb(/* red= */ 165, /* green= */ 105, /* blue= */ 49);

    @ColorInt
    public static final int TERTIARY60 =
            Color.rgb(/* red= */ 195, /* green= */ 130, /* blue= */ 72);

    @ColorInt
    public static final int TERTIARY70 =
            Color.rgb(/* red= */ 226, /* green= */ 156, /* blue= */ 95);

    @ColorInt
    public static final int TERTIARY80 =
            Color.rgb(/* red= */ 255, /* green= */ 183, /* blue= */ 122);

    @ColorInt
    public static final int TERTIARY90 =
            Color.rgb(/* red= */ 255, /* green= */ 220, /* blue= */ 194);

    @ColorInt
    public static final int TERTIARY95 =
            Color.rgb(/* red= */ 255, /* green= */ 238, /* blue= */ 226);
