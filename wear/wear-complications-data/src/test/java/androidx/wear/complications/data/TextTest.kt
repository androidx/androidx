...
@SmallTest
class AsWireComplicationTextTest {
    @Test
    fun plainText() {
        val text = ComplicationText.plain("abc")
        assertThat(text.asWireComplicationText())
...
@DoNotInstrumentPackage("androidx.wear.complications.data")
@SmallTest
class FromWireComplicationText {
    @Test
    fun plainText() {
    ...
    @Test
    fun timeFormatText() {
        var dateTimeMillis = Instant.parse("2020-12-30T10:15:20.00Z").toEpochMilli()
