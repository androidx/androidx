...
public class UserStyleCategoryWireFormat implements VersionedParcelable, Parcelable {
    ...
    @VersionedParcelize
    @SuppressLint("BanParcelableUsage") // TODO(b/169214666): Remove Parcelable
    public static class OptionWireFormat implements VersionedParcelable, Parcelable {
        ...
        /** Serializes this OptionWireFormat to the specified {@link Parcel}. */
        @Override
        public void writeToParcel(@NonNull Parcel parcel, int flags) {
            parcel.writeParcelable(ParcelUtils.toParcelable(this), flags);
        }
        ...
        public static final Parcelable.Creator<OptionWireFormat> CREATOR =
                new Parcelable.Creator<OptionWireFormat>() {
                    ...
                    @Override
                    public OptionWireFormat[] newArray(int size) {
                        return new OptionWireFormat[size];
                    }
                };
    }
}
