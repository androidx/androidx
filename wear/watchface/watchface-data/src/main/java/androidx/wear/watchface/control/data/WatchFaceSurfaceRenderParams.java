...
/**
 * Parameters for the renderWatchFaceToSurface AIDL methods.
 *
 * @hide
 */
...
public class WatchFaceSurfaceRenderParams implements VersionedParcelable, Parcelable {
    ...
    public WatchFaceSurfaceRenderParams(
    ...
    public static final Parcelable.Creator<WatchFaceSurfaceRenderParams> CREATOR =
            new Parcelable.Creator<WatchFaceSurfaceRenderParams>() {
                @SuppressWarnings("deprecation")
                @Override
                public WatchFaceSurfaceRenderParams createFromParcel(Parcel source) {
                    return ParcelUtils.fromParcelable(
                            source.readParcelable(getClass().getClassLoader()));
                }

                @Override
                public WatchFaceSurfaceRenderParams[] newArray(int size) {
                    return new WatchFaceSurfaceRenderParams[size];
                }
            };
}
