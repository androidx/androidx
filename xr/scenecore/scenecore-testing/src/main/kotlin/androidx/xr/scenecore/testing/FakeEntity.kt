...
public open class FakeEntity(public val name: String = "") : FakeScenePose(), Entity {
     ...
     *
     * @return Current [androidx.xr.runtime.math.Vector3] scale relative to the given space.
     */
     ...
     * the Entity.
     *
     * @param scale The [androidx.xr.runtime.math.Vector3] scale factor relative to the given space.
