...
/**
 * Manages the registration and request of runtime permissions.
 *
 * An instance of this class must be created during the Activity's initialization phase.
 *
 * @param activity The activity context used to register the result launcher.
 */
class SessionManager(private val activity: AppCompatActivity) {
