...
internal sealed interface GlimmerLazyListLayoutProperties {
...
internal val GlimmerLazyListLayoutProperties.isVertical: Boolean
    get() = orientation == Orientation.Vertical

private class GlimmerLazyListLayoutPropertiesImpl(
...
) : GlimmerLazyListLayoutProperties {
...
internal fun Density.resolveLayoutProperties(
    ...
    return GlimmerLazyListLayoutPropertiesImpl(
        orientation = orientation,
