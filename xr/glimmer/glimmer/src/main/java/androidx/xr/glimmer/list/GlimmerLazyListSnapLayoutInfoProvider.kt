...
public fun SnapLayoutInfoProvider(state: GlimmerLazyListState): SnapLayoutInfoProvider =
    GlimmerLazyListFocusAwareSnapLayoutInfoProvider(state)
 ...
 */
internal class GlimmerLazyListFocusAwareSnapLayoutInfoProvider(
    private val state: GlimmerLazyListState
