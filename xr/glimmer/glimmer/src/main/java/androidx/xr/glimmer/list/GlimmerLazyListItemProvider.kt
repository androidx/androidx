...
@Composable
internal fun rememberGlimmerLazyListItemProviderLambda(
    state: GlimmerLazyListState,
    content: GlimmerLazyListScope.() -> Unit,
): () -> GlimmerLazyListItemProvider {
    val latestContent = rememberUpdatedState(content)
    return remember(state) {
        val scope = GlimmerLazyListItemScopeImpl()
...
internal class GlimmerLazyListItemProvider(
    val itemScope: GlimmerLazyListItemScopeImpl,
    val intervalContent: LazyLayoutIntervalContent<GlimmerLazyListInterval>,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is GlimmerLazyListItemProvider) return false
