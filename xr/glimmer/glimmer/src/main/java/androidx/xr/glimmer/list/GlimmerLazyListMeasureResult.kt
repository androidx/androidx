...
internal class GlimmerLazyListMeasureResult(
    /** The new first visible item. */
    val firstVisibleItem: GlimmerLazyListMeasuredItem?,
    /** The new value for [GlimmerLazyListState.firstVisibleItemScrollOffset]. */
    ...
    // properties representing the info needed for [GlimmerLazyListLayoutInfo]:
    /** see [GlimmerLazyListLayoutInfo.visibleItemsInfo] */
    override val visibleItemsInfo: List<GlimmerLazyListMeasuredItem>,
    /** see [GlimmerLazyListLayoutInfo.viewportStartOffset] */
    override val viewportStartOffset: Int,
    /** see [GlimmerLazyListLayoutInfo.viewportEndOffset] */
    override val viewportEndOffset: Int,
    /** see [GlimmerLazyListLayoutInfo.totalItemsCount] */
    override val totalItemsCount: Int,
    /** see [GlimmerLazyListLayoutInfo.reverseLayout] */
    override val reverseLayout: Boolean,
    /** see [GlimmerLazyListLayoutInfo.orientation] */
    override val orientation: Orientation,
    override val afterContentPadding: Int,
    override val mainAxisItemSpacing: Int,
) : GlimmerLazyListLayoutInfo, MeasureResult by measureResult {
