 ...
 * of the list.
 */
internal sealed interface GlimmerLazyListAutoFocusScrollConverter {
 ...
 *   converter.
 */
internal object AutoFocusScrollConverter : GlimmerLazyListAutoFocusScrollConverter {
    ...
    private fun getConverter(
        ...
        viewportSize: Double,
        contentLength: Double,
    ): GlimmerLazyListAutoFocusScrollConverter {
        return when {
 ...
 * swiping.
 */
private object NoConversion : GlimmerLazyListAutoFocusScrollConverter {
    override fun convertUserScrollToContentScroll(
        userScroll: Double,
        scrollThreshold: Double,
        viewportSize: Double,
 ...
 */
private object LinearScrollConverter : GlimmerLazyListAutoFocusScrollConverter {
    override fun convertUserScrollToContentScroll(
        userScroll: Double,
        scrollThreshold: Double,
        viewportSize: Double,
 ...
 */
private object AdaptiveScrollConverter : GlimmerLazyListAutoFocusScrollConverter {
    override fun convertUserScrollToContentScroll(
        userScroll: Double,
        scrollThreshold: Double,
        viewportSize: Double,
...
internal fun GlimmerLazyListAutoFocusScrollConverter.convertUserScrollToContentScroll(
    userScroll: Double,
...
internal fun GlimmerLazyListAutoFocusScrollConverter.convertContentScrollToUserScroll(
    contentScroll: Double,
    properties: GlimmerLazyListAutoFocusProperties,
): Double {
