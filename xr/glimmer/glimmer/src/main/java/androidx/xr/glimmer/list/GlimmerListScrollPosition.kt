 ...
 */
internal class GlimmerListScrollPosition(initialIndex: Int = 0, initialScrollOffset: Int = 0) {
    ...
    fun updateFromMeasureResult(measureResult: GlimmerListMeasureResult) {
