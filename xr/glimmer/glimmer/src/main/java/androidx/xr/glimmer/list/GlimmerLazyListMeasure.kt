...
internal fun GlimmerLazyListLayoutProperties.measureGlimmerLazyList(
    itemsCount: Int,
    ...
    if (itemsCount <= 0) {
        ...
        return GlimmerLazyListMeasureResult(
    ...
    val visibleItems = ArrayDeque<GlimmerLazyListMeasuredItem>()
...
/** Calculates [GlimmerLazyListMeasuredItem]s offsets. */
private fun calculateItemsOffsets(
    items: List<GlimmerLazyListMeasuredItem>,
    extraItemsBefore: List<GlimmerLazyListMeasuredItem>,
    extraItemsAfter: List<GlimmerLazyListMeasuredItem>,
    layoutWidth: Int,
    layoutHeight: Int,
    ...
    reverseLayout: Boolean,
    density: Density,
): MutableList<GlimmerLazyListMeasuredItem> {
    ...
    val positionedItems =
        ArrayList<GlimmerLazyListMeasuredItem>(
...
private fun createItemsAfterList(
    visibleItems: MutableList<GlimmerLazyListMeasuredItem>,
    measuredItemProvider: GlimmerLazyListMeasuredItemProvider,
    pinnedItems: IntList,
): List<GlimmerLazyListMeasuredItem> {
    var list: MutableList<GlimmerLazyListMeasuredItem>? = null
