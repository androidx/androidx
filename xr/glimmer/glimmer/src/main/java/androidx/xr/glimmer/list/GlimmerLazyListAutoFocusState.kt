 ...
 * and later, once all children are placed, it is invoked by [GlimmerLazyListAutoFocusNode] to
 * perform the focus request.
 */
internal class GlimmerLazyListAutoFocusState {

    private var pendingRequestFocus = false

    var properties: GlimmerLazyListAutoFocusProperties? = null
        private set
    ...
    internal fun applyAutoFocusProperties(
        newProperties: GlimmerLazyListAutoFocusProperties?,
...
private fun getFocusLinePosition(
    state: GlimmerLazyListAutoFocusProperties,
