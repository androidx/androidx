...
public interface GlimmerLazyListLayoutInfo {
    /** The list of [GlimmerLazyListItemInfo] representing all the currently visible items. */
    ...
    /** The total count of items passed to [GlimmerLazyColumn]. */
...
internal val GlimmerLazyListLayoutInfo.mainAxisViewportSize: Int
    get() =
