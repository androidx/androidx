...
internal fun GlimmerLazyListLayoutProperties.applyMeasureResult(
    state: GlimmerLazyListState,
    itemsCount: Int,
    measuredItemProvider: GlimmerLazyListMeasuredItemProvider,
...
private fun GlimmerLazyListLayoutProperties.applyMeasureResultWithoutAutoFocus(
    state: GlimmerLazyListState,
    itemsCount: Int,
    measuredItemProvider: GlimmerLazyListMeasuredItemProvider,
    firstVisibleItemIndex: Int,
...
private fun GlimmerLazyListLayoutProperties.applyMeasureResultWithAutoFocus(
    state: GlimmerLazyListState,
    itemsCount: Int,
    measuredItemProvider: GlimmerLazyListMeasuredItemProvider,
    firstVisibleItemIndex: Int,
...
private fun convertUserScrollDeltaToContentScrollDelta(
    properties: GlimmerLazyListAutoFocusProperties?,
...
private fun calculateConsumedFocusDelta(
    ...
    prevAutoFocusProperties: GlimmerLazyListAutoFocusProperties?,
): Float {
...
private fun calculateAutoFocusProperties(
    layoutProperties: GlimmerLazyListLayoutProperties,
    measureResult: GlimmerLazyListMeasureResult,
): GlimmerLazyListAutoFocusProperties? {
    ...
    return GlimmerLazyListAutoFocusProperties(
 ...
 * viewport's top edge.
 */
private fun getTotalContentScrollDistance(measureResult: GlimmerLazyListMeasureResult): Int {
