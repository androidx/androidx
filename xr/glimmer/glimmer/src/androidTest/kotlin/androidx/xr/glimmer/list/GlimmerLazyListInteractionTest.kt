...
class GlimmerLazyListInteractionTest(orientation: Orientation) :
    ...
    @Test
    fun itemsExtensionOverload_forLazyList() {
        val itemsList = listOf("A", "B", "C", "D", "E")
        rule.setGlimmerThemeContent {
            GlimmerLazyColumn { items(itemsList) { item -> Text(item) } }
        }
    ...
    @Test
    fun itemsExtension_forIndexedLazyList() {
        val itemsList = listOf("A", "B", "C", "D", "E")
        rule.setGlimmerThemeContent {
            GlimmerLazyColumn {
