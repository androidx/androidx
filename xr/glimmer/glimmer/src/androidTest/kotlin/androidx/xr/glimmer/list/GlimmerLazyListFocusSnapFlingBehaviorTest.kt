...
class GlimmerLazyListFocusSnapFlingBehaviorTest(orientation: Orientation) :
    BaseGlimmerLazyListTestWithOrientation(orientation) {
    ...
    private val GlimmerLazyListState.focusLinePosition: Float
        get() {
