...
class GlimmerLazyColumnWithTitleTest {
    ...
    /**
     * Since we cannot provide a modifier to the underlying [GlimmerLazyColumn], we have a
     * workaround to find it, as the List is expected to be the only scrollable element.
     */
