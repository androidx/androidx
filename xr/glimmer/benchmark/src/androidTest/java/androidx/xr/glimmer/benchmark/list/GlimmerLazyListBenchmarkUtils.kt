...
internal interface GlimmerLazyListBenchmarkTestCase : ComposeTestCase {
    fun setUp()
...
internal fun ComposeBenchmarkRule.toggleStateBenchmark(
    caseFactory: () -> GlimmerLazyListBenchmarkTestCase
) {
    ...
    runBenchmarkFor(caseFactory) {
        ...
        measureRepeatedOnUiThread {
            runWithMeasurementDisabled {
                ...
                // TODO: b/448365164 - This line is specific for GlimmerLazyList.
                //  This line is needed because we track isScrollable state in composition.
                //  See androidx.xr.glimmer.list.GlimmerLazyList#isScrollEnabled.
                recompose()
                ...
                // TODO: b/448365164 - The two following lines of code are specific for
                //  GlimmerLazyList.
                ...
                //  PinnableItemContainer#pin. The list of pinned items is read inside
                //  GlimmerLazyList measure
...
private fun ComposeExecutionControl.performToggle(testCase: GlimmerLazyListBenchmarkTestCase) {
    testCase.toggle()
