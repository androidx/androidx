...
import androidx.xr.glimmer.samples.GlimmerLazyColumnWithTitleChipSample

internal val LazyListDemos =
    listOf(
        ComposableDemo("List with one-line items") { GlimmerLazyColumnOneLineItems() },
        ComposableDemo("List with two-line items") { GlimmerLazyColumnTwoLineItems() },
        ComposableDemo("List with a title chip") { GlimmerLazyColumnWithTitleChipSample() },
        ComposableDemo("List with items of different sizes") {
            GlimmerLazyColumnWithItemsOfDifferentSizes()
        },
        ComposableDemo("List with a controllable number of items") {
            GlimmerLazyColumnWithControllableNumberOfItems()
        },
    )

@Composable
private fun GlimmerLazyColumnOneLineItems() {
    val quickReplies =
...
@Composable
private fun GlimmerLazyColumnTwoLineItems() {
    GlimmerLazyColumn {
        items(10) { index ->
...
@Composable
private fun GlimmerLazyColumnWithItemsOfDifferentSizes() {
...
@Composable
private fun GlimmerLazyColumnWithControllableNumberOfItems() {
