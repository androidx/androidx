...
/*
 * Testing onWindowFocusChanged fires when it's supposed to in Full Space Mode
...
class FSMFocusChangeActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            FocusChangeContent(this, runAutomated, hasWindowFocus, isFullSpaceMode = true)
        }
    }
