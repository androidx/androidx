...
class ResizablePanel : ComponentActivity() {
    ...
    private fun PanelRow() {
        ...
        val transitionValue = remember { Animatable(250f) }
        ...
        SpatialColumn(verticalArrangement = SpatialArrangement.spacedBy(20.dp)) {
            SpatialRow(
                ...
                SpatialColumn(
                    ...
                    // Fixed Non-resizable panel with animation button
                    SpatialPanel(
                        modifier = SubspaceModifier.fillMaxWidth().height(250.dp).padding(20.dp)
                    ) {
                        Box(
                            ...
                            Column(
                                ...
                                Text(text = "FIXED", fontSize = 20.sp, color = Color.White)
                                Text(text = "non-resizable", fontSize = 20.sp, color = Color.White)
                                Button(
                                    modifier = Modifier.padding(top = 8.dp),
                                    onClick = {
                                        coroutineScope.launch {
                                            transitionValue.animateTo(
                                                targetValue = 350f,
                                                animationSpec =
                                                    infiniteRepeatable(
