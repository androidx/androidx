 ...
 *
 * @param horizontalPercent Value to feather horizontal edges. A value of 5 represents 5% of the
 *   width of the visible canvas. Accepted value range is 0 - 50 percent.
 * @param verticalPercent Value to feather vertical edges. A value of 5 represents 5% of the height
...
public fun spatialSmoothFeatheringEffect(
    ...
    SpatialSmoothFeatheringEffect(spatialSmoothFeatheringSize(horizontalPercent, verticalPercent))
