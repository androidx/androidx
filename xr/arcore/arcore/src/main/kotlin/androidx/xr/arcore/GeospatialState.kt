...
import androidx.xr.arcore.Geospatial.GeospatialTrackingState

@Deprecated(
    "Use Geospatial.GeospatialTrackingState instead.",
    ReplaceWith("Geospatial.GeospatialTrackingState"),
)
...
public class GeospatialState private constructor(internal val value: Int) {
    public companion object {
         ...
         */
        @JvmField public val RUNNING: GeospatialTrackingState = GeospatialTrackingState.RUNNING
         ...
         */
        @JvmField
        public val NOT_RUNNING: GeospatialTrackingState = GeospatialTrackingState.NOT_RUNNING
         ...
         */
        @JvmField
        public val ERROR_INTERNAL: GeospatialTrackingState = GeospatialTrackingState.ERROR_INTERNAL
         ...
         */
        @JvmField
        public val ERROR_NOT_AUTHORIZED: GeospatialTrackingState =
         ...
         * destroyed.
         */
        @JvmField public val PAUSED: GeospatialTrackingState = GeospatialTrackingState.PAUSED
    }
}
