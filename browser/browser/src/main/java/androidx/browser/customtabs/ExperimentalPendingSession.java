 ...
 * {@link CustomTabsClient#attachSession(CustomTabsSession.PendingSession)} which associates the
 * pending session with the service and turn it into a {@link CustomTabsSession}.
 */
