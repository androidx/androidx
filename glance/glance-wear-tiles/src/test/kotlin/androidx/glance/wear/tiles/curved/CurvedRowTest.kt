...
class CurvedRowTest {
        ...
        fakeCoroutineScope.runTest {
            val root = runTestingComposition {
                CurvedRow {
                    ...
                    curvedComposable(false) { Text(text = "hello3") }
    ...
    @Test
    fun createComposableCurvedLine() =
        fakeCoroutineScope.runTest {
            val root = runTestingComposition {
                CurvedRow {
                    curvedLine(
    ...
    @Test
    fun createComposableCurvedSpacer() =
        fakeCoroutineScope.runTest {
            val root = runTestingComposition {
                CurvedRow {
                    curvedSpacer(
                        curvedModifier = GlanceCurvedModifier.sweepAngleDegrees(60f).thickness(6.dp)
                    )
                }
            }
