...
class PaddingTest {
    ...
    @Test
    fun buildPadding() {
        val modifiers = GlanceModifier.padding(start = 1.dp, top = 2.dp, end = 3.dp, bottom = 4.dp)

        // Find the padding modifier...
        val paddingModifier = checkNotNull(modifiers.findModifier<PaddingModifier>())

        assertThat(paddingModifier)
            .isEqualTo(
                PaddingModifier(
    ...
    fun mergePadding_withRelativeOrientation() {
        val modifiers =
            GlanceModifier.padding(start = 15.dp, end = 12.dp, top = 20.dp)
    ...
    fun mergePadding_withAbsoluteOrientation() {
        val modifiers =
            GlanceModifier.absolutePadding(left = 15.dp, right = 12.dp)
    ...
    fun mergePadding_setOrientationToRelative() {
        val modifiers =
            GlanceModifier.absolutePadding(left = 10.dp, right = 10.dp)
    ...
    fun mergePadding_setOrientationToAbsolute() {
        val modifiers =
            GlanceModifier.padding(start = dimensionRes1, end = dimensionRes2)
