...
class GlanceNodeAssertionCollectionTest {
    ...
    fun assertAll_noNodesToAssertOn() {
        ...
        val assertion =
            getGlanceNodeAssertionCollectionFor(
    ...
    fun assertAll_noneMatch_throwsError() {
        ...
        val assertionError =
            assertThrows(AssertionError::class.java) { assertion.assertAll(hasText("substring")) }
    ...
    fun assertAny_noNodesToAssertOn_assertionError() {
        ...
        val assertionError =
            assertThrows(AssertionError::class.java) { assertion.assertAny(hasText("substring")) }
    ...
    fun assertAnyAfterFilter_noFilteredNodes_assertionError() {
        ...
        val assertionError =
            assertThrows(AssertionError::class.java) {
                assertion.filter(hasText("word")).assertAny(hasText("text"))
            }
    ...
    fun assertCountEqualsAfterFilter_noFilteredNodes_assertionError() {
        ...
        val assertionError =
            assertThrows(AssertionError::class.java) {
                assertion.filter(hasText("word")).assertCountEquals(1)
            }
    ...
    fun assertAnyOnChildren_noChildren_assertionError() {
        ...
        val assertionError =
            assertThrows(AssertionError::class.java) { assertion.onChildren().assertCountEquals(1) }
