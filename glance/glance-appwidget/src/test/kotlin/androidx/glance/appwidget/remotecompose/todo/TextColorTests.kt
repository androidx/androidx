...
class TextColorTests : BaseRemoteComposeTest() {
    ...
    @Test
    fun translateTextStyle_color_dynamicColor() = fakeCoroutineScope.runTest {
        TODO("write a test for dynamic color")
    }

    // TODO(b/450985714): Fix and re-enable this test
    @Ignore("Test not yet written, see b/450985714")
    @Test
    fun translateTextStyle_color_dayNightColorProvider() = fakeCoroutineScope.runTest {
    ...
    @Ignore("Test not yet written, see b/450985714")
    @Test
    fun translateTextStyle_color_resourceColorProvider() = fakeCoroutineScope.runTest {
