...
class SwitchBackportTranslatorTest {
    ...
    @Test
    fun canTranslateSwitch_fixed_unchecked() =
    ...
    @Test
    fun canTranslateSwitch_fixed_checked() =
        fakeCoroutineScope.runTest {
            val rv =
                context.runAndTranslate {
                    Switch(
    ...
    @Test
    fun canTranslateSwitch_dayNight_unchecked_day() =
        fakeCoroutineScope.runTest {
    ...
    @Test
    fun canTranslateSwitch_dayNight_unchecked_night() =
        fakeCoroutineScope.runTest {
            val thumbColor = Color.Blue
            val trackColor = Color.Cyan
            val otherColor = Color.White
    ...
    @Test
    fun canTranslateSwitch_dayNight_checked_day() =
        fakeCoroutineScope.runTest {
            val thumbColor = Color.Blue
            val trackColor = Color.Cyan
            val otherColor = Color.White
    ...
    @Test
    fun canTranslateSwitch_dayNight_checked_night() =
        fakeCoroutineScope.runTest {
            val thumbColor = Color.Blue
            val trackColor = Color.Cyan
            val otherColor = Color.White
    ...
    @Test
    fun canTranslateSwitch_resource_unchecked() =
        fakeCoroutineScope.runTest {
            val rv =
                lightContext.runAndTranslate {
                    Switch(
    ...
    @Test
    fun canTranslateSwitch_resource_checked() =
        fakeCoroutineScope.runTest {
            val rv =
                lightContext.runAndTranslate {
                    Switch(
    ...
    @Test
    fun canTranslateSwitch_onCheckedChange_null() =
        fakeCoroutineScope.runTest {
            val rv =
                context.runAndTranslate {
    ...
    @Test
    fun canTranslateSwitch_onCheckedChange_withAction() =
        fakeCoroutineScope.runTest {
            val rv =
                context.runAndTranslate {
                    Switch(
    ...
    @Test
    fun canTranslateSwitchWithSemanticsModifier_contentDescription() =
        fakeCoroutineScope.runTest {
            val rv =
                context.runAndTranslate {
                    Switch(
