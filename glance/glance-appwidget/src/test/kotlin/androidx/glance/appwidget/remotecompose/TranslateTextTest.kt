...
class TranslateTextTest : BaseRemoteComposeTest() {
    ...
    @Test
    fun translateText_basic() = fakeCoroutineScope.runTest {
    ...
    @Test
    fun translateTextStyle_fontSize() = fakeCoroutineScope.runTest {
        val string = "24sp"
        val size = 24
    ...
    @Test
    fun translateTextStyle_color_fixedColorProvider() = fakeCoroutineScope.runTest {
    ...
    @Test
    fun translateTextStyle_fontWeight_bold() = fakeCoroutineScope.runTest {
        // test 1: bold
    ...
    @Test
    fun translateTextStyle_fontWeight_Medium() = fakeCoroutineScope.runTest {
    ...
    @Test
    fun translateTextStyle_fontWeight_Normal() = fakeCoroutineScope.runTest {
    ...
    @Test
    fun translateTextStyle_fontStyle_normal() = fakeCoroutineScope.runTest {
    ...
    @Test
    fun translateTextStyle_fontStyle_italic() = fakeCoroutineScope.runTest {
        val fontStyle = FontStyle.Italic

        val rcTextLayout: TextLayout = testTextWithStyle(style = TextStyle(fontStyle = fontStyle))
        val actualStyle = getProperty<Int>(rcTextLayout, "fontStyle")
    ...
    @Test
    fun translateText_maxLines_3() = fakeCoroutineScope.runTest {
        val maxLines = 3
        val string = "hello world"
    ...
    @Test
    fun translateText_maxLines_default() = fakeCoroutineScope.runTest {
        val string = "hello world"
