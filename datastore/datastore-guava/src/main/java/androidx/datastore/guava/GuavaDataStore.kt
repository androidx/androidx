...
internal constructor(
    ...
    public class Builder<T : Any>(
         ...
         * The file is generated by File(this.filesDir, "datastore/$fileName"). The user is
         * responsible for ensuring that there is never more than one DataStore acting on a file at
         * a time.
         *
         ...
         * @param fileName the filename relative to [Context.filesDir] that [DataStore] acts on. The
