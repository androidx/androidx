...
internal class RxDataStoreSingletonDelegate<T : Any>
internal constructor(
    ...
    @GuardedBy("lock") @Volatile private var INSTANCE: RxDataStore<T>? = null
        ...
        return INSTANCE
            ?: synchronized(lock) {
                if (INSTANCE == null) {
                    ...
                    INSTANCE =
                        with(RxDataStoreBuilder(applicationContext, fileName, serializer)) {
