...
public fun persistableBundleOf(vararg pairs: Pair<String, Any?>): PersistableBundle {
...
public fun persistableBundleOf(): PersistableBundle {
 ...
 * @throws IllegalArgumentException When a value is not a supported type of [PersistableBundle].
 */
public fun Map<String, Any?>.toPersistableBundle(): PersistableBundle {
