...
public final class ResourcesCompat {
     ...
     * Returns a font Typeface associated with a particular resource ID.
     * <p>
     * This method will block the calling thread to retrieve the requested font if it is from a
     * font provider and <code>cacheOnly</code> is <code>false</code>. If you wish to not have
     * this behavior, use {@link #getFont(Context, int, FontCallback, Handler)} instead.
     * <p>
     * Prior to API level 23, font resources with more than one font in a family will only load the
     * font closest to a regular weight typeface.
     *
     ...
     *           package, type, and resource entry. The value 0 is an invalid
     *           identifier.
     * @param cacheOnly If this is <code>true</code> and the requesting font is already fetched,
     *                 this method immediately returns cached Typeface. If this is <code>true</code>
     *                  the requesting font is not yet fetched, this method immediately returns
     *                  null. If this is <code>false</code> and the requesting font is already
     *                  fetched, this method immediately returns cached Typeface. If this is
     *                  <code>false</code> and the requesting font is not yet fetched, this
     *                  method blocks calling thread for fetching font.
     * @return A font Typeface object.
     * @throws NotFoundException Throws NotFoundException if the given ID does not exist.
     *
     * @see #getFont(Context, int, FontCallback, Handler)
     */
    @Nullable
    public static Typeface getFont(@NonNull Context context, @FontRes int id, boolean cacheOnly)
            throws NotFoundException {
        if (context.isRestricted()) {
            return null;
        }
        return loadFont(context, id, new TypedValue(), Typeface.NORMAL, null /* callback */,
                null /* handler */, false /* isXmlRequest */, cacheOnly);
    }
