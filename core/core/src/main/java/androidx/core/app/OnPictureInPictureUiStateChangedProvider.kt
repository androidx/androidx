...
public interface OnPictureInPictureUiStateChangedProvider {
     ...
     * [Activity.onPictureInPictureUiStateChanged] with the new [PictureInPictureUiStateCompat].
     *
     * @param listener The listener that should be called whenever
     *   [Activity.onPictureInPictureUiStateChanged] was called.
     */
    public fun addOnPictureInPictureUiStateChangedListener(
     ...
     *   [addOnPictureInPictureUiStateChangedListener] that should be removed.
     */
    public fun removeOnPictureInPictureUiStateChangedListener(
        listener: Consumer<PictureInPictureUiStateCompat>
    )
}
