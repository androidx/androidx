...
class DateTimeFormatterCommonOptionsTest {
    ...
    fun test() {
        val commonFormats =
            mapOf(
                ...
                DateTimeFormatterCommonOptions.YEAR_MONTH_WEEKDAY_DAY to
    ...
    fun testProperDefinitionsAgainstIcu() {
        ...
        val commonFormats =
            mapOf(
                DateTimeFormatterCommonOptions.ABBR_MONTH_DAY to DateFormat.ABBR_MONTH_DAY,
                DateTimeFormatterCommonOptions.ABBR_MONTH_WEEKDAY_DAY to
                    DateFormat.ABBR_MONTH_WEEKDAY_DAY,
                DateTimeFormatterCommonOptions.HOUR24_MINUTE to DateFormat.HOUR24_MINUTE,
                DateTimeFormatterCommonOptions.HOUR24_MINUTE_SECOND to
                    DateFormat.HOUR24_MINUTE_SECOND,
                DateTimeFormatterCommonOptions.HOUR_MINUTE to DateFormat.HOUR_MINUTE,
                DateTimeFormatterCommonOptions.HOUR_MINUTE_SECOND to DateFormat.HOUR_MINUTE_SECOND,
                DateTimeFormatterCommonOptions.MINUTE_SECOND to DateFormat.MINUTE_SECOND,
                DateTimeFormatterCommonOptions.MONTH_DAY to DateFormat.MONTH_DAY,
                DateTimeFormatterCommonOptions.MONTH_WEEKDAY_DAY to DateFormat.MONTH_WEEKDAY_DAY,
                DateTimeFormatterCommonOptions.NUM_MONTH_DAY to DateFormat.NUM_MONTH_DAY,
                DateTimeFormatterCommonOptions.NUM_MONTH_WEEKDAY_DAY to
                    DateFormat.NUM_MONTH_WEEKDAY_DAY,
                DateTimeFormatterCommonOptions.YEAR_ABBR_MONTH to DateFormat.YEAR_ABBR_MONTH,
                DateTimeFormatterCommonOptions.YEAR_ABBR_MONTH_DAY to
                    DateFormat.YEAR_ABBR_MONTH_DAY,
                DateTimeFormatterCommonOptions.YEAR_ABBR_MONTH_WEEKDAY_DAY to
                    DateFormat.YEAR_ABBR_MONTH_WEEKDAY_DAY,
                DateTimeFormatterCommonOptions.YEAR_MONTH to DateFormat.YEAR_MONTH,
                DateTimeFormatterCommonOptions.YEAR_MONTH_DAY to DateFormat.YEAR_MONTH_DAY,
                DateTimeFormatterCommonOptions.YEAR_MONTH_WEEKDAY_DAY to
