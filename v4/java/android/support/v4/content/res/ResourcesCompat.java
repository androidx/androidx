...
public class ResourcesCompat {
     ...
     * <p>
     * Prior to {@link android.os.Build.VERSION_CODES#L API level 21}, the
     * theme will not be applied and this method simply calls through to
     * {@link Resources#getDrawable(int)}.
     *
     ...
     * <p>
     * Prior to {@link android.os.Build.VERSION_CODES#ICE_CREAM_SANDWICH_MR1 API level 15},
     * the theme and density will not be applied and this method simply calls
     * through to {@link Resources#getDrawable(int)}.
     * <p>
     * Prior to {@link android.os.Build.VERSION_CODES#L API level 21}, the
     * theme will not be applied and this method calls through to
     * {@link Resources#getDrawableForDensity(int, int)}.
     *
     * @param id The desired resource identifier, as generated by the aapt
     *           tool. This integer encodes the package, type, and resource
     *           entry. The value 0 is an invalid identifier.
     ...
     * <p>
     * Prior to {@link android.os.Build.VERSION_CODES#M API level 23}, the
     * theme will not be applied and this method calls through to
    ...
    public int getColor(@NonNull Resources res, @ColorRes int id, @Nullable Theme theme)
        ...
        if (SDK_INT >= 21) {
            return ResourcesCompatApi22.getColor(res, id, theme);
        } else {
     ...
     * Prior to {@link android.os.Build.VERSION_CODES#M API level 23}, the
     * theme will not be applied and this method calls through to
     * {@link Resources#getColorStateList(int)}.
     *
    ...
    public ColorStateList getColorStateList(@NonNull Resources res, @ColorRes int id,
            @Nullable Theme theme) throws NotFoundException {
        if (SDK_INT >= 21) {
            return ResourcesCompatApi22.getColorStateList(res, id, theme);
        } else {
