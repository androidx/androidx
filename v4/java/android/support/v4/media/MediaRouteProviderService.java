...
public abstract class MediaRouteProviderService extends Service {
    ...
    public IBinder onBind(Intent intent) {
        if (intent.getAction().equals(SERVICE_INTERFACE)) {
            if (mProvider == null) {
                mProvider = onCreateMediaRouteProvider();
        ...
        if (version >= CLIENT_VERSION_1) {
            ...
            if (index < 0) {
                ...
                if (client.register()) {
                    ...
                    if (requestId != 0) {
                        RouteProviderDescriptor descriptor = mProvider.getDescriptor();
    ...
    private void sendDescriptorChanged(MediaRouteProvider.RouteProviderDescriptor descriptor) {
