...
final class RegisteredMediaRouteProvider extends MediaRouteProvider
    ...
    public RouteController onCreateRouteController(String routeId) {
        RouteProviderDescriptor descriptor = getDescriptor();
        if (descriptor != null) {
    ...
    private void onConnectionDescriptorChanged(Connection connection,
        ...
        if (mActiveConnection == connection) {
            ...
            if (descriptor != null) {
                if (!mComponentName.getPackageName().equals(descriptor.getPackageName())) {
                    Log.w(TAG, this + ": Ignoring provider descriptor because it "
                            + "has the wrong package name: " + descriptor.getPackageName());
                    descriptor = null;
                }
            }
    ...
    private final class Connection implements DeathRecipient {
        ...
        public boolean onRegistered(int requestId, int serviceVersion,
            ...
            if (mServiceVersion == 0
                ...
                onConnectionDescriptorChanged(this,
                        RouteProviderDescriptor.fromBundle(descriptorBundle));
        ...
        private boolean sendRequest(int what, int requestId, int arg, Object obj, Bundle data) {
            ...
            try {
                ...
                // The service probably died.
                // If it did, then it will be handled elsewhere by the death recipient.
                // We wouldn't bother logging this except that it's possible we encountered
                // some other serious binder error that we'd like to know about.
