 ...
 *
 * <p>Sub menus do not support item icons, or nested sub menus.
 *
...
public interface SubMenu extends Menu {
    ...
    /**
     * Sets the submenu header's title to the title given in <var>titleRes</var> resource
     * identifier.
     *
    ...
    /**
     * Sets the submenu header's icon to the icon given in <var>icon</var> {@link Drawable}.
     *
    ...
    /**
     * Sets the header of the submenu to the {@link View} given in <var>view</var>. This replaces
     * the header title and icon (and those replace this).
     *
    ...
    /**
     * Gets the {@link MenuItem} that represents this submenu in the parent menu.  Use this for
     * setting additional item attributes.
     *
