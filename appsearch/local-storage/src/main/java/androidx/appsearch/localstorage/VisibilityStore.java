...
class VisibilityStore {
    ...
    @VisibleForTesting
    static final String VISIBILITY_TYPE = "VisibilityType";
    ...
    private static final AppSearchSchema VISIBILITY_SCHEMA =
            ...
            .addProperty(new AppSearchSchema.PropertyConfig.Builder(
                    ...
                    .build())
            .addProperty(new AppSearchSchema.PropertyConfig.Builder(PACKAGE_ACCESSIBLE_PROPERTY)
    ...
    public boolean isSchemaPackageAccessible(@NonNull String prefix,
            @NonNull String prefixedSchema, @NonNull PackageIdentifier accessingPackage) {
        Preconditions.checkNotNull(prefix);
        Preconditions.checkNotNull(prefixedSchema);
