...
public class LocalBackend {
    ...
    /**
     * Opens a new {@link AppSearchSession} on this backend.
     *
    ...
    public static ListenableFuture<AppSearchResult<AppSearchSession>> createSearchSession(
        ...
        ListenableFuture<AppSearchResult<LocalBackend>> instFuture = getInstance(context.mContext);
    ...
    /**
     * Opens a new {@link GlobalSearchSession} on this backend.
     *
     * <p>If the system is not initialized, it will be initialized using the provided
     * {@code context}.
     */
    ...
    /**
     * Returns the singleton instance of {@link LocalBackend}.
     *
     * <p>If the system is not initialized, it will be initialized using the provided
     * {@code context}.
     */
    ...
    @NonNull
    @VisibleForTesting
    static ListenableFuture<AppSearchResult<LocalBackend>> getInstance(@NonNull Context context) {
        Preconditions.checkNotNull(context);
