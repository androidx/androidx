...
public class AppSearchSessionGmsCtsTest extends AppSearchSessionCtsTestBase {
    ...
    protected ListenableFuture<AppSearchSession> createSearchSessionAsync(@NonNull String dbName)
        ...
        mIsGmsAvailable = isGmsAvailable(appSearchSessionListenableFuture);
    ...
    private boolean isGmsAvailable(
            ListenableFuture<AppSearchSession> sessionListenableFuture) throws Exception {
        try {
            ...
            if (exception.getCause() instanceof ApiException) {
                ...
                if (apiException.getStatusCode() == ConnectionResult.SIGN_IN_FAILED) {
