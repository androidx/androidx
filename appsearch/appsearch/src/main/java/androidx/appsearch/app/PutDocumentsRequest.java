...
// @exportToFramework:endStrip()
         ...
         *     <p>A qualified id is a string generated by package, database, namespace, and document
         *     id. See {@link androidx.appsearch.util.DocumentIdUtil#createQualifiedId} for more
         *     details.
         *
         *     <li>previousQueries: REPEATED STRING, the list of all previous user-entered search
         *     inputs, without any operators or rewriting, collected during this search session
         ...
         *     documents with corpus = ["corpus1", "corpus1", "corpus2", "corpus3", "corpus2"]. Then
         *     the block ranks of them = [1, 2, 1, 1, 2].
         ...
         *     AppSearch.
         *     <p>For example, AppSearch returns 2 pages with 10 {@link SearchResult} documents for
         *     each page. Then the global ranks of them will be 1 to 10 for the first page, and 11
         *     to 20 for the second page.
         *
