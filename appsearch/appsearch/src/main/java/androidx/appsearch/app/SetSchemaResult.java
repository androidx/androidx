...
public class SetSchemaResult {
    ...
    SetSchemaResult(@NonNull Bundle bundle) {
        ...
        mDeletedSchemaTypes = Preconditions.checkNotNull(
    ...
    /**
     * returns the {@link androidx.appsearch.app.AppSearchResult.ResultCode} of the
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder addIncompatibleSchemaType(
                @NonNull String incompatibleSchemaTypes) {
            Preconditions.checkState(!mBuilt, "Builder has already been used");
        ...
        /**
         * Sets the {@link androidx.appsearch.app.AppSearchResult.ResultCode} of the
         * {@link AppSearchSession#setSchema} call to  the {@link SetSchemaResult}
         */
        @NonNull
        ...
        public SetSchemaResult build() {
            ...
            bundle.putStringArrayList(SetSchemaResult.DELETED_SCHEMA_TYPES_FIELD,
                    mDeletedSchemaTypes);
            bundle.putStringArrayList(SetSchemaResult.INCOMPATIBLE_SCHEMA_TYPES_FIELD,
