...
// @exportToFramework:endStrip()
    ...
    @NonNull
    private static String formatGenericDocumentString(@NonNull GenericDocument document,
            int indentLevel) {
        ...
        stringBuilder.append(indentLevelOneString).append(
                "score: " + document.getScore()).append(",\n");

        stringBuilder.append(indentLevelOneString).append(
                "schemaType: \"").append(document.getSchemaType()).append("\",\n");

        stringBuilder.append(indentLevelOneString).append(
                "creationTimestampMillis: " + document.getCreationTimestampMillis()).append(",\n");

        stringBuilder.append(indentLevelOneString).append(
                "timeToLiveMillis: " + document.getTtlMillis()).append(",\n");
        ...
        for (String propertyName : document.getPropertyNames()) {
            ...
            stringBuilder.append(getIndent(indentLevel + 2)).append("\"").append(
