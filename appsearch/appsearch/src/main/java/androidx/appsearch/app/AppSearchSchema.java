...
public final class AppSearchSchema {
    ...
    @Override
    public int hashCode() {
        return ObjectsCompat.hash(getSchemaType(), getVersion(), getProperties());
    }
    ...
    public static final class Builder {
         ...
         * backwards-compatible changes or {@link SetSchemaRequest.Builder#setForceOverride}
         * method is set to {@code true}.
         *
         * @param version A non-negative int number represents the version of this
         *                {@link AppSearchSchema}, default version is 0.
         *
