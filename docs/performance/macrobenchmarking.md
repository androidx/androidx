...
specifics to writing library macrobenchmarks in the AndroidX repo.

For an overview of benchmarking in AndroidX and the difference between micro and
macrobenchmarks, see [Benchmarking in AndroidX](benchmarking.md).
