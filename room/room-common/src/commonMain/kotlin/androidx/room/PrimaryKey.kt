...
public annotation class PrimaryKey(
     ...
     *
     * If the field's type is [Integer] or [Long] (or its TypeConverter converts it to an [Integer]
     * or [Long]), [Insert] methods treat `null` as not-set while inserting the item.
     *
