 ...
 * <ul>
 *     <li>{@link com.android.support.room.Database Database}: This annotation marks a
 *     class as a database. It should be an abstract class that extends
 *     {@link com.android.support.room.RoomDatabase RoomDatabase}. At runtime, you can acquire an
 *     instance of it via {@link com.android.support.room.Room#databaseBuilder(
 *     android.content.Context,java.lang.Class, java.lang.String) Room.databaseBuilder} or
 *     {@link com.android.support.room.Room#inMemoryDatabaseBuilder(android.content.Context,
 ...
 *     </li>
 *     <li>{@link com.android.support.room.Dao Dao}: This annotation marks a class or interface as a
 *     Data Access Object. Data access objects are the main component of Room that are responsible
 *     for defining the methods that access the database. The class that is annotated with
 *     {@link com.android.support.room.Database Database} must have an abstract method that has
 *     0 arguments and returns the class that is annotated with Dao. While generating the code at
 ...
 * {@link com.android.support.room.InvalidationTracker InvalidationTracker} class which you can
 * acquire via {@link com.android.support.room.RoomDatabase#getInvalidationTracker()
 * RoomDatabase.getInvalidationTracker}.
 * <p>
 * For convenience, Room allows you to return {@link com.android.support.lifecycle.LiveData
 * LiveData} from {@link com.android.support.room.Query Query} methods. It will automatically
