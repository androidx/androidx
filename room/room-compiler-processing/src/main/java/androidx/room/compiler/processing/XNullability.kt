...
enum class XNullability {
    ...
    NULLABLE,
    /**
     * The type is guaranteed to be nonnull. This means it is either a Kotlin Type declared without
     * a `?` at the end or it is a Java type that has one of the `non-null` annotations (e.g.
