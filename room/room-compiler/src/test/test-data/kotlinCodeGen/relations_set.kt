...
public class MyDao_Impl(
  ...
  private fun __fetchRelationshipSongAsSong(_connection: SQLiteConnection, _map: MutableMap<Long, MutableSet<Song>>) {
    val __mapKeySet: Set<Long> = _map.keys
    if (__mapKeySet.isEmpty()) {
      return
    }
  ...
  private fun __fetchRelationshipSongAsSong_1(_connection: SQLiteConnection, _map: MutableMap<Long, MutableSet<Song>>) {
    val __mapKeySet: Set<Long> = _map.keys
    if (__mapKeySet.isEmpty()) {
      return
    }
