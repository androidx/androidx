...
class AbstractNode {
    ...
    fun detach() {
        assert(owner != null);
        owner = null;
        assert(parent == null || isAttached() == parent!!.isAttached());
    }
    ...
    @CallSuper
    protected fun adoptChild(child: AbstractNode) { // TODO(Migration/Filip): Removed covariant
        assert(child != null);
        assert(child.parent == null);
// TODO(Migration/Filip): Resolve assert
//        assert(() {
...
//        }());
    ...
    @CallSuper
    protected fun dropChild(child: AbstractNode) { // TODO(Migration/Filip): Removed covariant
        assert(child != null);
        assert(child.parent == this);
        assert(child.isAttached() == isAttached());
        child.parent = null;
        if (isAttached())
            child.detach();
    }
