...
//
    ...
    fun _debugTrackElementThatWillNeedToBeRebuiltDueToGlobalKeyShenanigans(node: Element, key: GlobalKey<*>) {
        ...
        val keys = _debugElementsThatWillNeedToBeRebuiltDueToGlobalKeyShenanigans!!.putIfAbsent(node, mutableSetOf());
        keys.add(key);
    }
