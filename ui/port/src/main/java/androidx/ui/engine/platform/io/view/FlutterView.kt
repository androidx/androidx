...
//    private val mTextInputPlugin: TextInputPlugin? = null
    private val mSurfaceCallback: SurfaceHolder.Callback? = null
...
//        mFlutterSettingsChannel = BasicMessageChannel(this, "flutter/settings", JSONMessageCodec.INSTANCE)
    ...
    private external fun nativeSurfaceCreated(nativePlatformViewAndroid: Long, surface: Surface,
                                              backgroundColor: Int)

    private external fun nativeSurfaceChanged(nativePlatformViewAndroid: Long, width: Int, height: Int)

    private external fun nativeSurfaceDestroyed(nativePlatformViewAndroid: Long)

    private external fun nativeSetViewportMetrics(nativePlatformViewAndroid: Long, devicePixelRatio: Float,
                                                  physicalWidth: Int, physicalHeight: Int, physicalPaddingTop: Int, physicalPaddingRight: Int,
                                                  physicalPaddingBottom: Int, physicalPaddingLeft: Int, physicalViewInsetTop: Int, physicalViewInsetRight: Int,
                                                  physicalViewInsetBottom: Int, physicalViewInsetLeft: Int)

    private external fun nativeGetBitmap(nativePlatformViewAndroid: Long): Bitmap

    private external fun nativeDispatchPointerDataPacket(nativePlatformViewAndroid: Long, buffer: ByteBuffer,
                                                         position: Int)

    private external fun nativeDispatchSemanticsAction(nativePlatformViewAndroid: Long, id: Int, action: Int,
                                                       args: ByteBuffer?, argsPosition: Int)

    private external fun nativeSetSemanticsEnabled(nativePlatformViewAndroid: Long, enabled: Boolean)
    ...
    private external fun nativeRegisterTexture(nativePlatformViewAndroid: Long, textureId: Long,
                                               surfaceTexture: SurfaceTexture)

    private external fun nativeMarkTextureFrameAvailable(nativePlatformViewAndroid: Long, textureId: Long)
