 ...
 * and forward those methods to this class as well.</p>
 */
class FlutterActivityDelegate(val activity: Activity , val viewFactory: ViewFactory) : FlutterActivityEvents, FlutterView.Provider, PluginRegistry {
