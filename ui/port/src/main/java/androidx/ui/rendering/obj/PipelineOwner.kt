...
//    }
    ...
    private val _nodesNeedingLayout: List<RenderObject>  = mutableListOf()
...
//        });
    ...
    private var _debugAllowMutationsToDirtySubtrees = false;
    ...
    private val _nodesNeedingCompositingBitsUpdate: List<RenderObject> =  mutableListOf();
    ...
    /// See [RendererBinding] for an example of how this function is used.
    fun flushPaint() {
        //TODO: profile(() { Timeline.startSync('Paint', arguments: timelineWhitelistArguments); });
        assert(() {
    ...
    val _nodesNeedingSemantics: Set<RenderObject> = mutableSetOf();
    ...
    fun flushSemantics() {
        ...
        try {
            val nodesToProcess = _nodesNeedingSemantics.toList()
