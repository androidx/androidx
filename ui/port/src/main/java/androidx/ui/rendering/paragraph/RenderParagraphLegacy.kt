...
// TODO(siyamed) This class has to be deleted once we move everything out of ui-port. I copied this
// class into ui-text instead of moving it to keep ui-port compiling and working. Right now
// RenderParagraph serves two masters crane and klutter and we cannot serve them both in ui-text.

class RenderParagraphLegacy(
    text: TextSpan,
