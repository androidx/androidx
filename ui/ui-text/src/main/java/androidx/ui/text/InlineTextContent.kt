...
internal const val INLINE_CONTENT_TAG = "androidx.ui.text.inlineContent"
 ...
 * @param id The id of this inline content, it is referred by the [androidx.ui.text.CoreText]
 ...
 * the inlineContent parameter of [androidx.ui.text.CoreText] doesn't contain [id]. Accessibility
 ...
 *
 * @sample androidx.ui.text.samples.InlineTextContentSample
 * @see CoreText
 * @see Placeholder
 */
