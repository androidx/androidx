...
class SemanticsProperties(
     ...
     */
    val onMoveCursorForwardByCharacter: ((extendSelection: Boolean) -> Unit)? = null,
    /**
     ...
     * input focus is in a text field.
     */
    val onMoveCursorBackwardByCharacter: ((extendSelection: Boolean) -> Unit)? = null,
    /**
     ...
     */
    val onSetSelection: ((selection: TextSelection) -> Unit)? = null,
    /**
     ...
     */
    val onDidGainAccessibilityFocus: (() -> Unit)? = null,
    /**
     ...
     *  * [FocusNode], [FocusScope], [FocusManager], which manage the input focus
     */
    val onDidLoseAccessibilityFocus: (() -> Unit)? = null,
    /**
