...
fun localLoadStatesOf(
    refreshLocal: LoadState = NotLoading.Idle,
    prependLocal: LoadState = NotLoading.Idle,
    appendLocal: LoadState = NotLoading.Idle
) = CombinedLoadStates(
    source = LoadStates(
...
fun remoteLoadStatesOf(
    ...
    prependLocal: LoadState = NotLoading.Idle,
    appendLocal: LoadState = NotLoading.Idle,
    refreshRemote: LoadState = NotLoading.IdleRemote,
    prependRemote: LoadState = NotLoading.IdleRemote,
    appendRemote: LoadState = NotLoading.IdleRemote
) = CombinedLoadStates(
    source = LoadStates(
        refresh = refreshLocal,
        prepend = prependLocal,
