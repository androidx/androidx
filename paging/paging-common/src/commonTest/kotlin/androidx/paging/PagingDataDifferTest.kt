...
class PagingDataDifferTest {
    ...
    @Test
    fun refresh_loadStates(collectWithCachedIn: Boolean) =
    ...
    @Test
    fun refresh_loadStates_afterEndOfPagination(collectWithCachedIn: Boolean) =
    ...
    @Test
    fun appendInvalid_loadStates(collectWithCachedIn: Boolean) =
    ...
    @Test
    fun prependInvalid_loadStates(collectWithCachedIn: Boolean) =
        runTest(collectWithCachedIn, initialKey = 50) { differ,
        pagingSources, _, _ ->
        val collectLoadStates = launch { differ.collectLoadStates() }
    ...
    @Test
    fun refreshInvalid_loadStates(collectWithCachedIn: Boolean) =
        runTest(collectWithCachedIn, initialKey = 50) { differ,
        pagingSources, _, _ ->
        val collectLoadStates = launch { differ.collectLoadStates() }
    ...
    @Test
    fun appendError_retryLoadStates(collectWithCachedIn: Boolean) =
        runTest(collectWithCachedIn) { differ, pagingSources, _, _ ->
        val collectLoadStates = launch { differ.collectLoadStates() }
    ...
    @Test
    fun prependError_retryLoadStates(collectWithCachedIn: Boolean) =
        runTest(collectWithCachedIn, initialKey = 50) { differ,
        pagingSources, _, _ ->
        val collectLoadStates = launch { differ.collectLoadStates() }
    ...
    @Test
    fun refreshError_retryLoadStates(collectWithCachedIn: Boolean) =
        runTest(collectWithCachedIn) { differ, pagingSources, _, _ ->
        val collectLoadStates = launch { differ.collectLoadStates() }
    ...
    @Test
    fun prependError_refreshLoadStates(collectWithCachedIn: Boolean) =
        runTest(collectWithCachedIn, initialKey = 50) { differ,
        pagingSources, _, _ ->
        val collectLoadStates = launch { differ.collectLoadStates() }
    ...
    @Test
    fun refreshError_refreshLoadStates(collectWithCachedIn: Boolean) =
        runTest(collectWithCachedIn) { differ, pagingSources,
        _, _ ->
        val collectLoadStates = launch { differ.collectLoadStates() }
