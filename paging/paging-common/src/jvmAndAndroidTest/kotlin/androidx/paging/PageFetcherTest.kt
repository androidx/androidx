...
class PageFetcherTest {
    ...
    @Test
    fun append_invalidatePropagatesThroughLoadResultInvalid() = testScope.runTest {
        val pagingSources = mutableListOf<TestPagingSource>()
        val pageFetcher =
            PageFetcher(
    ...
    @Test
    fun prepend_invalidatePropagatesThroughLoadResultInvalid() = testScope.runTest {
        val pagingSources = mutableListOf<TestPagingSource>()
        val pageFetcher =
            PageFetcher(
                pagingSourceFactory = { TestPagingSource().also { pagingSources.add(it) } },
    ...
    @Test
    fun jump_prependPlaceholders() = testScope.runTest {
        val pagingSources = mutableListOf<PagingSource<Int, Int>>()
    ...
    @Test
    fun jump_appendPlaceholders() = testScope.runTest {
        val pagingSources = mutableListOf<PagingSource<Int, Int>>()
        val pagingSourceFactory = suspend { TestPagingSource().also { pagingSources.add(it) } }
        val config =
            PagingConfig(
    ...
    @Test
    fun jump_prependPlaceholdersThenAppendPlaceholders() = testScope.runTest {
        val pagingSources = mutableListOf<PagingSource<Int, Int>>()
        val pagingSourceFactory = suspend { TestPagingSource().also { pagingSources.add(it) } }
        val config =
            PagingConfig(
    ...
    fun cachesPreviousPagingStateOnEmptyPages() = testScope.runTest {
        ...
        assertThat(remoteMediator.newLoadEvents)
            .containsExactly(RemoteMediatorMock.LoadEvent(loadType = REFRESH, state = pagingState))
    ...
    @Test
    fun append_NoMoreDataNoOp() = testScope.runTest {
    ...
    @Test
    fun prepend_NoMoreDataNoOp() = testScope.runTest {
    ...
    @Test
    fun appendPrepend() = testScope.runTest {
        val pageFetcher =
            PageFetcher(
                pagingSourceFactory,
                50,
    ...
    @Test
    fun appendRefresh() = testScope.runTest {
        val pageFetcher =
            PageFetcher(
                pagingSourceFactory,
                50,
    ...
    @Test
    fun appendDoesNotOverrideAccessedIndex() = testScope.runTest {
        val pageFetcher =
            PageFetcher(
                pagingSourceFactory,
                50,
    ...
    @Test
    fun prependRefresh() = testScope.runTest {
        val pageFetcher =
            PageFetcher(
                pagingSourceFactory,
                50,
    ...
    @Test
    fun prependDoesNotOverrideAccessedIndex() = testScope.runTest {
        val pageFetcher =
            PageFetcher(
                pagingSourceFactory,
                50,
    ...
    @Test
    fun refreshAll() = testScope.runTest {
        val pageFetcher =
            PageFetcher(
                pagingSourceFactory,
                50,
    ...
    @Test
    fun refreshAllAfterDrop() = testScope.runTest {
        val pageFetcher =
            PageFetcher(
                pagingSourceFactory,
                50,
    ...
    @Test
    fun refreshItem() = testScope.runTest {
        val pageFetcher = PageFetcher(pagingSourceFactory, 50, config)
        val fetcherState = collectFetcherState(pageFetcher)
