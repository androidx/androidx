...
internal actual class TestNavigator : Navigator<NavDestination>("test") {
    actual override fun createDestination(): NavDestination = NavDestination(this)
}

@Suppress("EXPECT_ACTUAL_CLASSIFIERS_ARE_IN_BETA_WARNING")
internal actual class TestTransitionNavigator actual constructor() :
    Navigator<NavDestination>("test") {
...
@Suppress("EXPECT_ACTUAL_CLASSIFIERS_ARE_IN_BETA_WARNING")
internal actual class FloatingWindowTestNavigator : Navigator<FloatingTestDestination>("test") {
    actual override fun createDestination(): FloatingTestDestination = FloatingTestDestination(this)
}

@Suppress("EXPECT_ACTUAL_CLASSIFIERS_ARE_IN_BETA_WARNING")
internal actual class SupportingPaneTestNavigator :
    Navigator<SupportingPaneTestDestination>("test") {
