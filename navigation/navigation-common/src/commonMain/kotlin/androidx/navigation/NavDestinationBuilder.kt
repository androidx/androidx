...
public expect open class NavDestinationBuilder<out D : NavDestination> {
    ...
    /** Add a [NavArgument] to this destination. */
    @Suppress("BuilderSetStyle") public fun argument(name: String, argument: NavArgument)
     ...
     * @param navDeepLink the NavDeepLink to be added to this destination
     */
    @Suppress("BuilderSetStyle") public fun deepLink(navDeepLink: NavDeepLink)
     ...
     */
    @Suppress("BuilderSetStyle") protected open fun instantiateDestination(): D
