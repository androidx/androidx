...
class RateLimitedLatencyAggregatorTest {
    ...
    @Test
    fun rateLimitedLatencyAggregator_reportsAtExpectedInterval() = testScope.runTest {
    ...
    @Test
    fun rateLimitedLatencyAggregator_doesNotReportWhenNoInputs() = testScope.runTest {
        var numReports = 0
        val sampleStarts = mutableListOf<Long>()
        val sampleEnds = mutableListOf<Long>()
    ...
    @Test
    fun rateLimitedLatencyAggregator_reportSynchronouslyReportsSynchronously() = testScope.runTest {
        val sampleStarts = mutableListOf<Long>()
        val sampleEnds = mutableListOf<Long>()
    ...
    @Test
    fun rateLimitedLatencyAggregator_canStartTwoAggregatorsInSameCoroutine() = testScope.runTest {
    ...
    @Test
    fun rateLimitedLatencyAggregator_cancelingScopeCancelsAggregator() = testScope.runTest {
        val sampleStarts = mutableListOf<Long>()
        val sampleEnds = mutableListOf<Long>()
