...
class BrushBehaviorTest {
            ...
            input =
                DampingNode(
                    ...
                    input =
                        ResponseNode(
                            responseCurve =
                                EasingFunction.Steps(2, EasingFunction.StepPosition.JUMP_BOTH),
                            input =
                                ToolTypeFilterNode(
    ...
    @Test
    fun brushBehavior_usesPassedInNodes() {
        val terminalNode = createTestStepBehaviorTerminalNode()
        val behavior = BrushBehavior(terminalNode)
        assertThat(behavior.terminalNodes).hasSize(1)
        assertThat(behavior.terminalNodes[0]).isSameInstanceAs(terminalNode)
    }
