...
actual internal object SourceNodeNative {
    ...
    actual fun getSourceInt(nativePointer: Long): Int = SourceNodeNative_getSourceInt(nativePointer)

    actual fun getValueRangeStart(nativePointer: Long): Float =
        SourceNodeNative_getValueRangeStart(nativePointer)

    actual fun getValueRangeEnd(nativePointer: Long): Float =
        SourceNodeNative_getValueRangeEnd(nativePointer)
