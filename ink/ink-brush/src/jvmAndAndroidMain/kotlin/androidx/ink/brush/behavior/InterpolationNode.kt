...
private constructor(
    ...
    public constructor(
        ...
        InterpolationNodeNative.createInterpolation(interpolation.value),
        paramInput,
        startInput,
        endInput,
    )
    ...
    public val interpolation: Interpolation =
        InterpolationNodeNative.getInterpolation(nativePointer)
...
private object InterpolationNodeNative {
    ...
    fun getInterpolation(nativePointer: Long): InterpolationNode.Interpolation =
        InterpolationNode.Interpolation.fromInt(getInterpolationInt(nativePointer))
