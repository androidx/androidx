...
private constructor(
    ...
    public val integralOutOfRangeBehavior: OutOfRange =
        OutOfRange.fromInt(IntegralNodeNative.getOutOfRangeBehaviorInt(nativePointer))
 ...
 */
expect internal object IntegralNodeNative {
    fun create(
        integrateOver: Int,
        integralValueRangeStart: Float,
        integralValueRangeEnd: Float,
    ...
    fun getIntegrateOverInt(nativePointer: Long): Int
