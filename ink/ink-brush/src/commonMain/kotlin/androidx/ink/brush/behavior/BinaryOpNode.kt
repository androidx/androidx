...
private constructor(
...
) : ValueNode(nativeAlloc, listOf(firstInput, secondInput)) {
    ...
    ) : this({ BinaryOpNodeNative.create(operation.value) }, firstInput, secondInput)
    ...
    internal companion object {
        internal fun wrapNative(
            ...
            return BinaryOpNode(nativeAlloc, firstInput, secondInput)
        }
    }

    /** The binary operation to perform. */
    public val operation: BinaryOp =
        BinaryOpNode.BinaryOp.fromInt(BinaryOpNodeNative.getOperationInt(nativePointer))
    ...
    private constructor(@JvmField internal val value: Int, private val name: String) {
         ...
         *
         * By default, decoding a [androidx.ink.brush.BrushFamily] containing a [BinaryOp] with a
 ...
 */
expect internal object BinaryOpNodeNative {
