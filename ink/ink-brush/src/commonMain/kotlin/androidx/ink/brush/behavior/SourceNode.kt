...
public class SourceNode private constructor(nativeAlloc: () -> Long) :
    ...
    public val sourceOutOfRangeBehavior: OutOfRange =
        OutOfRange.fromInt(SourceNodeNative.getOutOfRangeBehaviorInt(nativePointer))
    ...
    internal constructor(@JvmField internal val value: Int, private val name: String) {
        ...
        /**
         * Returns the minimum required [Version] for this [Source].
         *
         * By default, decoding a [androidx.ink.brush.BrushFamily] containing a [Source] with a
        ...
        public fun calculateMinimumRequiredVersion(): Version =
            Version.fromInt(SourceNodeNative.getSourceMinimumRequiredVersion(value))
 ...
 */
expect internal object SourceNodeNative {
    fun create(
        source: Int,
        sourceValueRangeStart: Float,
        sourceValueRangeEnd: Float,
    ...
    fun getSourceInt(nativePointer: Long): Int

    fun getValueRangeStart(nativePointer: Long): Float

    fun getValueRangeEnd(nativePointer: Long): Float

    fun getOutOfRangeBehaviorInt(nativePointer: Long): Int

    fun getSourceMinimumRequiredVersion(sourceInt: Int): Int
}
