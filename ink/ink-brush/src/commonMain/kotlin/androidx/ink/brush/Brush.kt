...
private constructor(
    ...
    public val family: BrushFamily =
        // If we just constructed this in Kotlin, use the family provided.
        family
...
expect internal object BrushNative {
    fun create(
    ...
    fun computeComposeColorLong(nativePointer: Long): Long

    fun getSize(nativePointer: Long): Float

    fun getEpsilon(nativePointer: Long): Float

    fun newCopyOfBrushFamily(nativePointer: Long): Long
}
