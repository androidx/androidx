...
/**
 * Marks declarations that are are an **experimental** Ink API for partially erasing strokes. These
 ...
 * opt-in requirement annotation as its argument: `@OptIn(ExperimentalInkEraserApi::class)`.
 */
@MustBeDocumented
...
public annotation class ExperimentalInkEraserApi
