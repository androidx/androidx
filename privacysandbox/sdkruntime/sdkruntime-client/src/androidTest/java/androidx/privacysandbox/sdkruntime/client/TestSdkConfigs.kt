...
internal object TestSdkConfigs {
    ...
    val CURRENT: LocalSdkConfig by lazy { forSdkName("current") }
     ...
     */
    val CURRENT_WITH_RESOURCES: LocalSdkConfig by lazy { forSdkName("currentWithResources") }

    /**
     * Return LocalSdkConfig for TestSDK. TestSDK should be registered in RuntimeEnabledSdkTable.xml
     * with package name: "androidx.privacysandbox.sdkruntime.testsdk.[testSdkName]"
     */
    fun forSdkName(testSdkName: String): LocalSdkConfig {
        ...
        return ALL_CONFIGS.getSdkConfig(sdkPackageName)
