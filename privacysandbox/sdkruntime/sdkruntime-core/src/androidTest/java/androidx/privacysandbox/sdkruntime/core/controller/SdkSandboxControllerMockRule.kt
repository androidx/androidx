...
class SdkSandboxControllerMockRule : ExternalResource() {
    ...
    lateinit var contextSpy: Context
    lateinit var sdkSandboxControllerMock: SdkSandboxController
    lateinit var controllerCompat: SdkSandboxControllerCompat

    override fun before() {
        sdkSandboxControllerMock = Mockito.mock(SdkSandboxController::class.java)
