...
package androidx.privacysandbox.ui.macrobenchmark.testapp.mediateesdkprovider
...
class MediateeSdkApiImpl(private val sdkContext: Context) : IMediateeSdkApi {
    override suspend fun loadAd(
        ...
        return androidx.privacysandbox.ui.macrobenchmark.testapp.sdkproviderutils.MediateeSdkApiImpl
            .loadAdUtil(adFormat, adType, waitInsideOnDraw, drawViewability, sdkContext)
    }
}
