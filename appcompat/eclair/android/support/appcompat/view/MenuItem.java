...
public interface MenuItem {
    ...
    */
     ...
     * MenuItem#SHOW_AS_ACTION_COLLAPSE_ACTION_VIEW} is expanded or collapsed.
     *
    ...
    public interface OnActionExpandListener {
        ...
        /**
         * Called when a menu item with {@link MenuItem#SHOW_AS_ACTION_COLLAPSE_ACTION_VIEW} is
         * expanded.
         *
    ...
    /**
     * Return the identifier for this menu item.  The identifier can not be changed after the menu
     * is created.
     *
    ...
    /**
     * Return the group identifier that this menu item is part of. The group identifier can not be
    ...
    /**
     * Change the condensed title associated with this item. The condensed title is used in
     * situations where the normal title may be too long to be displayed.
     *
    ...
    /**
     * Retrieve the current condensed title of the item. If a condensed title was never set, it will
     ...
     *
     * @param intent The Intent to associated with the item.  This Intent object is <em>not</em>
     *               copied, so be careful not to modify it later.
     * @return This Item so additional setters can be called.
     * @see #getIntent
     */
    ...
    /**
     * Return the Intent associated with this item.  This returns a reference to the Intent which
     * you can change as desired to modify what the Item is holding.
     *
     ...
     *                    12-key) keyboard.
     * @param alphaChar   The alphabetic shortcut key. This is the shortcut when using a keyboard
    ...
    /**
     * Sets the visibility of the menu item. Even if a menu item is not visible, it may still be
     * invoked via its shortcut (to completely disable an item, set it to invisible and {@link
    ...
    /**
     * Sets whether the menu item is enabled. Disabling a menu item will not allow it to be invoked
     * via its shortcut. The menu item will still be visible.
     *
    ...
    /**
     * Get the sub-menu to be invoked when this item is selected, if it has one. See {@link
     * #hasSubMenu()}.
     *
    ...
    /**
     * Gets the extra information linked to this menu item.  This extra information is set by the
     * View that added this menu item to the menu.
     *
     * @return The extra information linked to the View that added this menu item to the menu. This
     *         can be null.
     ...
     * provider set via {@link #setActionProvider(ActionProvider)}. </p>
     *
     ...
     * listener has been set using {@link #setOnActionExpandListener(OnActionExpandListener)} it
     * will have its {@link OnActionExpandListener#onMenuItemActionExpand(MenuItem)} method invoked.
     * The listener may return false from this method to prevent expanding the action view.
     *
     ...
     * listener has been set using {@link #setOnActionExpandListener(OnActionExpandListener)} it
     * will have its {@link OnActionExpandListener#onMenuItemActionCollapse(MenuItem)} method
    ...
    /**
     * Set an {@link OnActionExpandListener} on this menu item to be notified when the associated
