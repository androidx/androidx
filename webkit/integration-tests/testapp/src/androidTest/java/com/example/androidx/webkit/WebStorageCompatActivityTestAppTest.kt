...
/** Integration test for {@link WebStorageCompatActivity}. */
@RunWith(AndroidJUnit4::class)
@LargeTest
class WebStorageCompatActivityTestAppTest {

    @get:Rule val rule = ActivityScenarioRule(WebStorageCompatActivity::class.java)
    ...
    @Test
    fun testWebStorageCompatActivityLoadsCurrentDate() {
