...
/**
 * Parameters for customizing the prerender. Use the {@link Builder} to construct.
 */
...
public final class PrerenderParameters {
    ...
    private PrerenderParameters(@NonNull Map<String, String> additionalHeaders,
            @Nullable NoVarySearchHeader noVarySearchHeader, @Nullable Integer variationsId) {
    ...
    /**
     * A builder class to use to construct the {@link PrerenderParameters}.
     */
    public static final class Builder {
        ...
        /**
         * Build the {@link PrerenderParameters}.
         */
        @Profile.ExperimentalUrlPrefetch
        public @NonNull PrerenderParameters build() {
            return new PrerenderParameters(mAdditionalHeaders, mExpectedNoVarySearchHeader,
                    mVariationsId);
        }
