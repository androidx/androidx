...
public class SingleFragmentTestBase {
    ...
    @Rule
    public AnimationActivityTestRule<SingleFragmentTestActivity> activityTestRule =
            new AnimationActivityTestRule<>(SingleFragmentTestActivity.class, false, false);
