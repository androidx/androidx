...
internal class PageObjectsPaginator(
    ...
    private val objectsProvider: PageObjectsProvider,
    ...
    companion object {
        /** The maximum size of a single batch of objects in bytes. */
        private const val MAX_BATCH_SIZE_IN_BYTES: Int = 1000000
    }
}
