...
public class RemoveDraftEditOperation(public val id: String, override val pageNum: Int) :
    DraftEditOperation {
    override fun equals(other: Any?): Boolean {
        if (this === other) return true
        if (other !is RemoveDraftEditOperation) return false
        return id == other.id && pageNum == other.pageNum
    }

    override fun hashCode(): Int = 31 * id.hashCode() + pageNum
}
