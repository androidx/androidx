 ...
 * [androidx.credentials.agesignals.AgeSignalProvider] interface.
 */
@RestrictTo(RestrictTo.Scope.LIBRARY)
public class AgeSignalProviderMetadataHolder : Service() {
    ...
    internal inner class LocalBinder : Binder() {
        fun getService(): AgeSignalProviderMetadataHolder = this@AgeSignalProviderMetadataHolder
    }
