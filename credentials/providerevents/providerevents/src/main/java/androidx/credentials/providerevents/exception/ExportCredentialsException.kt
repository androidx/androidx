...
public class ExportCredentialsException(public val type: String, message: String) :
    Exception(message) {
    public companion object {
        /** The credential json cannot be read because it is written in invalid format */
        public const val INVALID_JSON_TYPE: String =
            "androidx.credentials.providerevents.exception.ExportCredentialsException.INVALID_JSON_TYPE"

        /** The credential json cannot be trusted because the caller is unknown */
        public const val UNKNOWN_CALLER_TYPE: String =
            "androidx.credentials.providerevents.exception.ExportCredentialsException.UNKNOWN_CALLER_TYPE"

        /** Used by the system when the request fails to reach the provider */
        public const val SYSTEM_ERROR_TYPE: String =
            "androidx.credentials.providerevents.exception.ExportCredentialsException.SYSTEM_ERROR_TYPE"

        /** The credential json cannot be stored due to unknown error */
        public const val UNKNOWN_ERROR_TYPE: String =
            "androidx.credentials.providerevents.exception.ExportCredentialsException.UNKNOWN_ERROR_TYPE"
    }
}
