...
public class GetCredentialTransferCapabilitiesUnknownCallerException(errorMessage: String? = null) :
    ...
    internal companion object {
        internal const val TYPE_GET_CREDENTIAL_TRANSFER_CAPABILITIES_UNKNOWN_CALLER_EXCEPTION:
            String =
            "androidx.credentials.providerevents.exception.TYPE_GET_CREDENTIAL_TRANSFER_CAPABILITIES_UNKNOWN_CALLER_EXCEPTION"
    }
}
