...
public class CreatePublicKeyCredentialNotSupportedExceptionJavaTest {
    ...
    public void construct_inputNonEmpty_success() throws
        ...
        throw new CreatePublicKeyCredentialNotSupportedException(
                "msg");
    }
    ...
    public void construct_errorMessageNull_success() throws
            CreatePublicKeyCredentialNotSupportedException {
        throw new CreatePublicKeyCredentialNotSupportedException(null);
    }

    @Test
    public void getter_success() {
        String expectedMessage = "msg";
        CreatePublicKeyCredentialNotSupportedException exception = new
                CreatePublicKeyCredentialNotSupportedException(expectedMessage);
        String expectedType =
                CreatePublicKeyCredentialNotSupportedException
