...
public class CreatePublicKeyCredentialNotAllowedExceptionJavaTest {
    ...
    public void construct_inputNonEmpty_success() throws
        ...
        throw new CreatePublicKeyCredentialNotAllowedException(
                "msg");
    }
    ...
    public void construct_errorMessageNull_success() throws
            CreatePublicKeyCredentialNotAllowedException {
        throw new CreatePublicKeyCredentialNotAllowedException(null);
    }

    @Test
    public void getter_success() {
        String expectedMessage = "msg";
        CreatePublicKeyCredentialNotAllowedException exception = new
                CreatePublicKeyCredentialNotAllowedException(expectedMessage);
        String expectedType =
                CreatePublicKeyCredentialNotAllowedException
