...
@SmallTest
class CreateCredentialProviderConfigurationExceptionTest {
    @Test(expected = CreateCredentialProviderConfigurationException::class)
    fun construct_inputNonEmpty_success() {
        throw CreateCredentialProviderConfigurationException("msg")
    }

    @Test(expected = CreateCredentialProviderConfigurationException::class)
    fun construct_errorMessageNull_success() {
        throw CreateCredentialProviderConfigurationException(null)
    }
