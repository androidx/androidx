...
@SmallTest
class GetCredentialProviderConfigurationExceptionTest {
    @Test(expected = GetCredentialProviderConfigurationException::class)
    fun construct_inputNonEmpty_success() {
        throw GetCredentialProviderConfigurationException("msg")
    }

    @Test(expected = GetCredentialProviderConfigurationException::class)
    fun construct_errorMessageNull_success() {
        throw GetCredentialProviderConfigurationException(null)
    }
    ...
    fun getter_success() {
        ...
        val exception = GetCredentialProviderConfigurationException(expectedMessage)
