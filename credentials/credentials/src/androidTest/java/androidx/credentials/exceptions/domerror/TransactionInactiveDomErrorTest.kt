...
@SmallTest
class TransactionInactiveDomErrorTest {
    @Test
    ...
    @Test
    fun getter_success() {
        val error = TransactionInactiveError()
        val expectedType =
            TransactionInactiveError.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_TRANSACTION_INACTIVE_ERROR
