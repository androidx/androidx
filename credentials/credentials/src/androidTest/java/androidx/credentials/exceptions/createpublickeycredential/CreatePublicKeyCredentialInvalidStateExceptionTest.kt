...
class CreatePublicKeyCredentialInvalidStateExceptionTest {
    @Test(expected = CreatePublicKeyCredentialInvalidStateException::class)
    fun construct_inputNonEmpty_success() {
        throw CreatePublicKeyCredentialInvalidStateException(
            "msg"
        )
    }
    ...
    fun construct_errorMessageNull_success() {
        throw CreatePublicKeyCredentialInvalidStateException(null)
    }

    @Test
    fun getter_success() {
        val expectedMessage = "msg"
        val exception = CreatePublicKeyCredentialInvalidStateException(expectedMessage)
        val expectedType =
