...
class CallingAppInfoApi21Test {
    ...
    fun constructor_success() {
        CallingAppInfo("name", signatures)
    }

    @Test
    fun constructor_success_withOrigin() {
        val callingAppInfo = CallingAppInfo(packageName, signatures, ORIGIN)
    ...
    fun getOrigin_noMatchPackageName1_throwsException() {
        val callingAppInfo = CallingAppInfo("incorrect_package_name", signatures, ORIGIN)
    ...
    fun getOrigin_noMatchCert_originNull_throwsException() {
        val callingAppInfo = CallingAppInfo(packageName, signatures, null)
    ...
    fun isOriginPopulated_originNotPopulated_returnsFalse() {
        val callingAppInfo = CallingAppInfo(packageName, signatures)
