 ...
 * @hide
 */
class CreatePublicKeyCredentialTimeoutException @JvmOverloads constructor(
    ...
    companion object {
        ...
        const val TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_TIMEOUT_EXCEPTION: String =
            "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_TIMEOUT_EXCEPTION"
    }
}