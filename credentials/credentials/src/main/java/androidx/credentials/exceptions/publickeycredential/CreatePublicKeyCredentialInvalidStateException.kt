 ...
 * @hide
 */
class CreatePublicKeyCredentialInvalidStateException @JvmOverloads constructor(
    ...
    companion object {
        ...
        const val TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_INVALID_STATE_EXCEPTION: String =
            "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_INVALID_STATE_EXCEPTION"
    }
}