 ...
 * @hide
 */
class CreatePublicKeyCredentialEncodingException @JvmOverloads constructor(
    ...
    companion object {
        ...
        const val TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_ENCODING_EXCEPTION: String =
            "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_ENCODING_EXCEPTION"
    }
}