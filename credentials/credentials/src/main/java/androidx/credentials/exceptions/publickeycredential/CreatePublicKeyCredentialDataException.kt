 ...
 * @hide
 */
class CreatePublicKeyCredentialDataException @JvmOverloads constructor(
    ...
    companion object {
        ...
        const val TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DATA_EXCEPTION: String =
            "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_DATA_EXCEPTION"
    }
}