 ...
 * @hide
 */
class CreatePublicKeyCredentialNotSupportedException @JvmOverloads constructor(
    ...
    companion object {
        ...
        const val TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_NOT_SUPPORTED_EXCEPTION: String =
            "androidx.credentials.TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_NOT_SUPPORTED_EXCEPTION"
    }
}