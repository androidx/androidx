 ...
 * exception contains a timeout_err code from the fido spec, indicating the operation timed out. The
...
public class TimeoutError : DomError(TYPE_CREATE_PUBLIC_KEY_CREDENTIAL_TIMEOUT_ERROR) {
