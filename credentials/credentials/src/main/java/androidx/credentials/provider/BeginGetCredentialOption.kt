 ...
 * Classes derived from this base class contain parameters required to retrieve a specific type of
 * credential. E.g. [BeginGetPasswordOption] contains parameters required to retrieve passwords.
 *
 * [BeginGetCredentialRequest] will be composed of a list of [BeginGetCredentialOption] subclasses
 * to indicate the specific credential types and configurations that the credential provider must
 * include while building the [BeginGetCredentialResponse].
 *
 * @property id unique id representing this particular option, to be used while constructing the
 *   [CredentialEntry] to be set on [BeginGetCredentialResponse]
 ...
 *   the raw [Bundle] - can typically be ignored by the credential provider as the required
