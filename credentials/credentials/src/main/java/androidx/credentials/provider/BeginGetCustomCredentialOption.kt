 ...
 * [BeginGetPasswordOption], [BeginGetPublicKeyCredentialOption], etc., then you should check if you
 * have any other library at interest that supports this custom [type] of credential option, and if
 * so use its parsing utilities to resolve to a type-safe class within that library.
 *
 * @property type the credential type determined by the credential-type-specific subclass generated
