 ...
 * [PasswordCredential], [PublicKeyCredential], etc., then you should check if you have any other
 * library at interest that supports this custom [type] of credential, and if so use its parsing
 * utilities to resolve to a type-safe class within that library.
 *
