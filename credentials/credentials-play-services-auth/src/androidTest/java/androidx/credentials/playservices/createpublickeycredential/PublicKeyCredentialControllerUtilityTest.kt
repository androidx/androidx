...
class PublicKeyCredentialControllerUtilityTest {
    ...
    private val JSON_KEYS_TO_EXPECTED_VAULES =
        mapOf(
            ...
            PublicKeyCredentialControllerUtility.Companion.JSON_KEY_ATTESTATION_OBJ to
                "attestationObject",
            PublicKeyCredentialControllerUtility.Companion.JSON_KEY_AUTH_DATA to
                "authenticatorData",
    ...
    private val ERROR_CODE_TO_TYPES =
        mapOf(
            ...
            ErrorCode.ABORT_ERR to
                TEST_DOM_EXCEPTION_PREFIX + "androidx.credentials.TYPE_ABORT_ERROR",
            ...
            ErrorCode.DATA_ERR to
                TEST_DOM_EXCEPTION_PREFIX + "androidx.credentials.TYPE_DATA_ERROR",
    ...
    fun verifyJsonKeyNamingHasNotChanged() {
        JSON_KEYS_TO_EXPECTED_VAULES.forEach { entry ->
            assertThat(entry.key).isEqualTo(entry.value)
        }
    }
    ...
    fun verifyCheckAlgSupported() {
        assertThat(PublicKeyCredentialControllerUtility.Companion.checkAlgSupported(-7))
            .isTrue() // es-256
        assertThat(PublicKeyCredentialControllerUtility.Companion.checkAlgSupported(999999))
            .isFalse()
    }
    ...
    fun convertToPlayAuthPasskeyJsonRequest_success() {
        ...
        val output =
            PublicKeyCredentialControllerUtility.Companion.convertToPlayAuthPasskeyJsonRequest(
                option
            )
