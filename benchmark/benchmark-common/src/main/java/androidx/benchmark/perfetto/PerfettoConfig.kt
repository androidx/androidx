...
public sealed class PerfettoConfig(internal val isTextProto: Boolean) {
    internal abstract fun writeTo(virtualFile: VirtualFile)
     ...
     */
    public class Binary(public val bytes: ByteArray) : PerfettoConfig(isTextProto = false) {
     ...
     */
    public class Text(public val text: String) : PerfettoConfig(isTextProto = true) {
        override fun writeTo(virtualFile: VirtualFile) {
     ...
     */
    @RestrictTo(RestrictTo.Scope.LIBRARY_GROUP)
    public class MinimalTest(private val appTagPackages: List<String>) :
        PerfettoConfig(isTextProto = false) {
        override fun writeTo(virtualFile: VirtualFile) {
            virtualFile.writeBytes(
