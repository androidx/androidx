...
object DeviceInfo {
    ...
    private fun queryArtMainlineVersion(): Long {
        ...
        val artMainlinePackage = try {
            pm.getApplicationInfo("com.google.android.art", PackageManager.MATCH_APEX)
        } catch (notFoundException: PackageManager.NameNotFoundException) {
            throw AssertionError(
                "Unable to find installed ART mainline module (com.google.android.art)",
                notFoundException
            )
        }
