...
internal val ATTRIBUTE_FLAVOR =
    Attribute.of("androidx.baselineprofile.gradle.attributes.Flavor", String::class.java)
internal val ATTRIBUTE_BUILD_TYPE =
    Attribute.of("androidx.baselineprofile.gradle.attributes.BuildType", String::class.java)
