...
public class SafeParcelStream extends SafeParcel {
    ...
    public SafeParcelStream(InputStream input, OutputStream output) {
    ...
    protected SafeParcel createSubParcel() {
        return new SafeParcelStream(mCurrentInput, mCurrentOutput);
    }
