...
class AnnotatedAppFunctionServiceEntryPoint(
    ...
    fun validate(): AnnotatedAppFunctionServiceEntryPoint {
        ...
        validateSuperClass()
        validateIsAbstract()
        validateOnExecuteFunctionIsNotImplemented()
    ...
    private fun validateOnExecuteFunctionIsNotImplemented() {
        val onExecuteFunction =
        ...
        if (onExecuteFunction != null && Modifier.ABSTRACT !in onExecuteFunction.modifiers) {
            throw ProcessingException(
