 ...
 *
 * Implementations of this interface are generated by the AppFunction compiler for interfaces
 * annotated with [AppFunctionSignature], and should not be manually implemented.
 *
 * Instances of this adapter can be obtained via
