...
class MemoryEstimationTest {
    ...
    fun memoryAccountingHandlesMultipleFramesCorrectly() =
        testScope.runTest {
            ...
            // We use removeFirstFrameReferenceAndAcquire{true} as a workaround to bypass
            // a known leak in the base removeFirstReference() method.
            val frame1 = frameBuffer.removeFirstFrameReferenceAndAcquire { true }
            ...
            val frame2 = frameBuffer.removeFirstFrameReferenceAndAcquire { true }
    ...
    fun multipleFrameBuffersShareMemoryCorrectly() =
        testScope.runTest {
            ...
            val acquired1 = buffer1.removeFirstFrameReferenceAndAcquire { true }
    ...
    fun outOfOrderFrameRemovalTracksMemoryCorrectly() =
        testScope.runTest {
            ...
            // buffer.
            val frame1 = frameBuffer.removeFirstFrameReferenceAndAcquire { true }
            val frame3 = frameBuffer.removeLastFrameReferenceAndAcquire { true }
