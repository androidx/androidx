...
class MemoryEstimationTest {
    ...
    @Test
    fun acquiringFrameHidesMemoryFromEviction() = testScope.runTest {
        val streamId = frameGraph.streams[streamConfigLarge]!!.id
        val frameBuffer = frameGraph.captureWith(setOf(streamId), capacity = 5)
    ...
    @Test
    fun closingExternalFrameRestoresEvictableMemory() = testScope.runTest {
        val streamId = frameGraph.streams[streamConfigLarge]!!.id
        val frameBuffer = frameGraph.captureWith(setOf(streamId), capacity = 5)
    ...
    @Test
    fun closingBufferAndExternalFrameCompletelyFreesMemory() = testScope.runTest {
        val streamId = frameGraph.streams[streamConfigLarge]!!.id
        val frameBuffer = frameGraph.captureWith(setOf(streamId), capacity = 5)
    ...
    @Test
    fun multipleFrameBuffersShareMemoryCorrectly() = testScope.runTest {
        val streamId = frameGraph.streams[streamConfigLarge]!!.id
    ...
    @Test
    fun frameCaptureHidesMemoryFromEviction() = testScope.runTest {
        val streamId = frameGraph.streams[streamConfigLarge]!!.id
    ...
    @Test
    fun rapidAcquireAndCloseDoesNotLeak() = testScope.runTest {
        val streamId = frameGraph.streams[streamConfigLarge]!!.id
        val frameBuffer = frameGraph.captureWith(setOf(streamId), capacity = 5)
    ...
    @Test
    fun independentStreamsHaveIndependentAccounting() = testScope.runTest {
    ...
    @Test
    fun mixedBufferAndCaptureUsageAccounting() = testScope.runTest {
        val streamId = frameGraph.streams[streamConfigLarge]!!.id
    ...
    @Test
    fun reducingCapacityEvictsOldestFrameAndRestoresMemory() = testScope.runTest {
        val streamId = frameGraph.streams[streamConfigLarge]!!.id
    ...
    @Test
    fun outOfOrderFrameRemovalTracksMemoryCorrectly() = testScope.runTest {
        val streamId = frameGraph.streams[streamConfigLarge]!!.id
        val frameBuffer = frameGraph.captureWith(setOf(streamId), capacity = 5)
    ...
    @Test
    fun multipleOverlappingCapturesTrackMemoryCorrectly() = testScope.runTest {
        val streamId = frameGraph.streams[streamConfigLarge]!!.id
