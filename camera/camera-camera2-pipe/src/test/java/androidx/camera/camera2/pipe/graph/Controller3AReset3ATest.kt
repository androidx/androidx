...
class Controller3AReset3ATest {
    ...
    @Test
    fun reset3A_afterUpdate3A__resetsAfRegions() = testScope.runTest {
    ...
    @Test
    fun reset3A_afterUpdate3A_resetsAeRegions() = testScope.runTest {
        val snapshot = controller3A.state3ASnapshot()
    ...
    @Test
    fun reset3a_afterUpdate3A_resetsAwbRegions() = testScope.runTest {
        val snapshot = controller3A.state3ASnapshot()
    ...
    @Test
    fun reset3A_afterUpdate3A_resets3ARegions() = testScope.runTest {
        val snapshot = controller3A.state3ASnapshot()
    ...
    @Test
    fun reset3A_afterUpdate3a_resetsModesAndRegionsToBefore() = testScope.runTest {
    ...
    @Test
    fun reset3A_afterLockAe_unlocksAe() = testScope.runTest {
        val snapshot = controller3A.state3ASnapshot()
    ...
    @Test
    fun reset3A_afterUnlockAe_noOp() = testScope.runTest {
        val snapshot = controller3A.state3ASnapshot()
    ...
    @Test
    fun reset3A_afterUnlockAe_locksToBefore() = testScope.runTest {
        controller3A.lock3A(aeLockBehavior = Lock3ABehavior.IMMEDIATE)
        advanceUntilIdle()
        captureSequenceProcessor.nextEvent()
        captureSequenceProcessor.nextEvent()
    ...
    @Test
    fun reset3A_afterUnlockAeAwb_locksToBefore() = testScope.runTest {
        controller3A.lock3A(
    ...
    @Test
    fun reset3A_afterLockAf_unlocksAf() = testScope.runTest {
        val snapshot = controller3A.state3ASnapshot()
    ...
    @Test
    fun reset3A_afterUnlockAf_locksToBefore() = testScope.runTest {
        controller3A.lock3A(afLockBehavior = Lock3ABehavior.IMMEDIATE)
        advanceUntilIdle()
        captureSequenceProcessor.nextEvent()
        captureSequenceProcessor.nextEvent()
    ...
    @Test
    fun reset3A_afterUnlockAeAfAwb_locksToBefore() = testScope.runTest {
        controller3A.lock3A(
            aeLockBehavior = Lock3ABehavior.IMMEDIATE,
        ...
        val unlockRepeatingRepeatingParams = captureSequenceProcessor.nextEvent().requiredParameters
        assertThat(unlockRepeatingRepeatingParams[CaptureRequest.CONTROL_AE_LOCK]).isEqualTo(false)
        assertThat(unlockRepeatingRepeatingParams[CaptureRequest.CONTROL_AWB_LOCK]).isEqualTo(false)
