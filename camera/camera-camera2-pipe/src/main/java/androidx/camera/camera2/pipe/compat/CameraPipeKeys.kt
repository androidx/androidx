...
public object CameraPipeKeys {
    ...
    public val camera2ExtensionMode: PipeMetadata.Key<Int> =
        PipeMetadata.Key.create("androidx.camera.camera2.pipe.extensionMode")

    /** Key for configuring the tag for a Camera2 CaptureRequest. */
    public val camera2CaptureRequestTag: PipeMetadata.Key<Any> =
        PipeMetadata.Key.create("androidx.camera.camera2.pipe.captureRequestTag")
     ...
     */
    public val ignore3ARequiredParameters: PipeMetadata.Key<Boolean> =
        PipeMetadata.Key.create("androidx.camera.camera2.pipe.ignore3ARequiredParameters")
