...
public class AutoFlashAEModeDisabler {
    ...
    public int getCorrectedAeMode(int aeMode) {
        CrashWhenTakingPhotoWithAutoFlashAEModeQuirk autoFlashQuirk = DeviceQuirks.get(
                CrashWhenTakingPhotoWithAutoFlashAEModeQuirk.class);

        if (autoFlashQuirk != null && aeMode == CaptureRequest.CONTROL_AE_MODE_ON_AUTO_FLASH) {
