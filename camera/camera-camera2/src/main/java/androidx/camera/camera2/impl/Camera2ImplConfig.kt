...
import androidx.camera.camera2.impl.Camera2ImplConfig.Companion.CAPTURE_REQUEST_ID_STEM
import androidx.camera.camera2.interop.CaptureRequestOptions
import androidx.camera.camera2.interop.CaptureRequestOptions.Builder.Companion.from
...
public class Camera2ImplConfig(config: Config) : CaptureRequestOptions(config) {
     ...
     * [androidx.camera.camera2.interop.Camera2Interop.Extender] to add Camera2 options on existing
     * other [ExtendableBuilder].
     */
