...
public class DeviceQuirks {
    ...
    /**
     * Forces the reload of the device quirks. This is useful in tests that modify/mock device
     * properties to verify device specific behavior.
     */
    @VisibleForTesting
    ...
    /**
     * Goes through all defined device-specific quirks, and adds them to `sQuirks` if they should
     * be loaded on the current device.
     */
    private static void loadQuirks() {
