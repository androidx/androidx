...
class CaptureViewOnTouchListener
  ...
  // TODO: Use a Handler for a background thread, rather than running on the current (main) thread.
  ...
  public boolean onTouch(View view, MotionEvent event) {
    switch (event.getAction()) {
      case MotionEvent.ACTION_DOWN:
        ...
        viewBoundsRect = new Rect(view.getLeft(), view.getTop(), view.getRight(), view.getBottom());
  ...
  private File createNewFile(String extension) {
    ...
    return new File(
        ...
        new SimpleDateFormat(FILENAME, Locale.US).format(System.currentTimeMillis()) + extension);
  }
  ...
  @Override
  public void onError(
      VideoCaptureUseCase.UseCaseError useCaseError, String message, @Nullable Throwable cause) {
    report("Failure");
  }
