...
public class MainFragment extends Fragment {
  ...
  @Nullable private CompoundButton toggleCameraButton;
    ...
    if (bundle != null) {
      ...
      if (captureModeString != null) {
        CaptureMode captureMode =
            CaptureMode.valueOf(captureModeString.toUpperCase());
  ...
  public void onViewStateRestored(@Nullable Bundle savedInstanceState) {
    ...
    if (toggleCameraButton != null) {
      toggleCameraButton.setOnCheckedChangeListener(
          (b, checked) ->
              cameraView.setCameraByLensFacing(checked ? LensFacing.FRONT : LensFacing.BACK));
    }

    toggleCropButton.setChecked(cameraView.getScaleType() == ScaleType.CENTER_CROP);
    toggleCropButton.setOnCheckedChangeListener((b, checked) -> {
      if (checked) {
        ...
        .addOnGlobalLayoutListener(
            new ViewTreeObserver.OnGlobalLayoutListener() {
              ...
              public void onGlobalLayout() {
                ...
                Log.d(TAG, "View " + name + " Center " + rect.centerX() + " " + rect.centerY());
                File externalDir = getActivity().getExternalFilesDir(null);
                File logFile = new File(externalDir, name + "_button_coordinates.txt");
