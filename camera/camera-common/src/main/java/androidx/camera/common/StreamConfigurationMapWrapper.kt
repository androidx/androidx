...
public interface StreamConfigurationMapWrapper : UnsafeWrapper {
    ...
    /** @see android.hardware.camera2.params.StreamConfigurationMap.getOutputSizes */
    public fun getOutputSizes(@ImageFormat format: Int): List<Size>
    ...
    public fun getHighResolutionOutputSizes(@ImageFormat format: Int): List<Size>

    /** @see android.hardware.camera2.params.StreamConfigurationMap.getOutputMinFrameDuration */
    public fun getOutputMinFrameDuration(@ImageFormat format: Int, size: Size): Long
    ...
    public fun getOutputStallDuration(@ImageFormat format: Int, size: Size): Long
