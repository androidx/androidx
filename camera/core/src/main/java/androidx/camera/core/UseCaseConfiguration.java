...
public interface UseCaseConfiguration<T extends BaseUseCase> extends TargetConfiguration<T> {
   ...
   *
   * <p>TODO(b/120949879): This may be removed when SessionConfig removes all camera2 dependencies.
   *
   * @param valueIfMissing The value to return if this configuration option has not been set.
   * @return The stored value or <code>valueIfMissing</code> if the value does not exist in this
   *     configuration.
  ...
  interface Builder<T, C extends Configuration, B extends Builder<T, C, B>>
     ...
     *
     * <p>The stream resource of {@link android.hardware.camera2.CameraDevice} is limited. When one
     * use case occupies a larger stream resource, it will impact the other use cases to get smaller
     * stream resource. Use this to determine which use case can have higher priority to occupancy
     * stream resource first.
     *
     * @param priority The priority to occupancy the available stream resource. Higher value will
