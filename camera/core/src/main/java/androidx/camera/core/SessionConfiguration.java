...
public final class SessionConfiguration {
  ...
  public static class Builder extends BaseBuilder {
     ...
     *     <p>TODO(b/120949879): This is camera2 implementation detail that should be moved
     */
    ...
    // TODO(b/120949879): This is camera2 implementation detail that should be moved
    public void setSessionStateCallback(CameraCaptureSession.StateCallback sessionStateCallback) {
      this.sessionStateCallback = sessionStateCallback;
    }
  ...
  public static final class ValidatingBuilder extends BaseBuilder {
    ...
    /**
     * Add the SessionConfiguration to the set of SessionConfiguration that have been aggregated by
     * the ValidatingBuilder
     */
    public void add(SessionConfiguration sessionConfiguration) {
      ...
      // Check template
      if (!templateSet) {
        captureRequestConfigBuilder.setTemplateType(captureRequestConfiguration.getTemplateType());
        templateSet = true;
      ...
      captureRequestConfigBuilder.getSurfaces().addAll(captureRequestConfiguration.getSurfaces());
      ...
      for (Map.Entry<Key<?>, CaptureRequestParameter<?>> entry :
        ...
        if (captureRequestConfigBuilder.getCharacteristic().containsKey(entry.getKey())) {
          ...
          captureRequestConfigBuilder.getCharacteristic().put(entry.getKey(), entry.getValue());
        }
      }
    }
