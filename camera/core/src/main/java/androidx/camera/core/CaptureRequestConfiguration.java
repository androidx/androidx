...
public final class CaptureRequestConfiguration {
   ...
   *     class.
   * @param templateType The template for parameters of the CaptureRequest. This must match the
  ...
  public CaptureRequest.Builder buildCaptureRequest(@Nullable CameraDevice device)
    ...
    for (CaptureRequestParameter<?> captureRequestParameter : captureRequestParameters.values()) {
  ...
  public static final class Builder {
     ...
     *
     * @param templateType Template constant that must match those defined by {@link CameraDevice}
     */
    ...
    /**
     * Builds an instance of a CaptureRequestConfiguration that has all the combined parameters of
     * the CaptureRequestConfiguration that have been added to the Builder.
     */
