...
public final class SurfaceCombination {
  ...
  public boolean isSupported(List<SurfaceConfiguration> configurationList) {
    ...
    /**
     * Sublist of this surfaceConfiguration may be able to support the desired configuration. For
     * example, (PRIV, PREVIEW) + (PRIV, ANALYSIS) + (JPEG, MAXIMUM) can supported by the following
     * level3 camera device combination - (PRIV, PREVIEW) + (PRIV, ANALYSIS) + (JPEG, MAXIMUM) +
     * (RAW, MAXIMUM).
     */
