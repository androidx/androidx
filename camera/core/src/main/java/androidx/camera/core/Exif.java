...
public final class Exif {
  ...
  /**
   * @return The timestamp (in millis) that this picture was modified, or {@link #INVALID_TIMESTAMP}
  ...
  /**
   * @return The timestamp (in millis) that this picture was taken, or {@link #INVALID_TIMESTAMP} if
  ...
  public void rotate(int degrees) {
    if (degrees % 90 != 0) {
      ...
      exifInterface.setAttribute(
          ExifInterface.TAG_ORIENTATION, String.valueOf(ExifInterface.ORIENTATION_UNDEFINED));
      return;
    }
