...
public final class Recorder implements VideoOutput {
    ...
    /**
     * Generates a {@link PendingRecording} with this Recorder, which provides the controls of a
     * idling recorder.
     *
     * <p>Before Android O, MediaMuxer doesn't support file descriptor as output destination. If
     * attempting to use a {@link FileDescriptorOutputOptions} on OS before Android O, an
     * {@link IllegalArgumentException} will be thrown.
     *
     * @param options the options that configures how the output will be handled.
     ...
     * @throws IllegalArgumentException if the OS is before Android O and the specified options
     * is an {@link FileDescriptorOutputOptions}.
     */
    @NonNull
    public PendingRecording prepareRecording(@NonNull OutputOptions options) {
        Preconditions.checkNotNull(options, "The OutputOptions cannot be null.");
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.O
                && options instanceof FileDescriptorOutputOptions) {
