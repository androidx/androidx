...
data class ViewfinderTestParams(
    ...
    val sourceResolution: Size = when (sourceRotation) {
        0, 180 -> TEST_RESOLUTION
        90, 270 -> TEST_RESOLUTION.swapDimens()
    ...
    val transformationInfo: TransformationInfo = TransformationInfo(
