...
object VisualizationDefaults {
    ...
    val keysVisualizedAsKeyValuePair: List<CameraMetadataKey> =
        listOf(
    ...
    val keysVisualizedAsStateGraph: Set<CameraMetadataKey> =
        setOf(
            CameraMetadataKey.CONTROL_AE_MODE,
            CameraMetadataKey.CONTROL_AF_MODE,
            CameraMetadataKey.CONTROL_AWB_MODE,
...
object StateDetails {
    val intToStringMap: Map<CameraMetadataKey, Map<Int, String>> =
        mapOf(
