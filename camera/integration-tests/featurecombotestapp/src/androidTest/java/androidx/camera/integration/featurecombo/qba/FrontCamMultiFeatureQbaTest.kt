...
/** Tests [FeatureGroupQueryBindAlignmentTestBase] for front cameras with multiple features. */
@LargeTest
@RunWith(Parameterized::class)
class FrontCamMultiFeatureQbaTest(
    testName: String,
        ...
        fun data() =
            mutableListOf<Array<Any?>>().apply {
                CameraUtil.getAvailableCameraSelectors()
                    .filter { it.lensFacing == CameraSelector.LENS_FACING_FRONT }
                    .forEach { selector ->
