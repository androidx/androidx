...
constructor(
     ...
     * and fills [points] with the points specific to the segment type. Each pair of floats in the
     * [points] array represents a point for the given segment. The number of pairs of floats
     ...
     * - [Done][PathSegment.Type.Done]: 0 pair This method does not allocate any memory.
     *
     * @param points A [FloatArray] large enough to hold 8 floats starting at [offset], throws an
...
/**
 * Creates a new [PathIterator] for this [path][android.graphics.Path] that evaluates conics as
