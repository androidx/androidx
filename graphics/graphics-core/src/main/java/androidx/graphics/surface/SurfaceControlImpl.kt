...
internal interface SurfaceControlImpl {
    ...
    /**
     * Interface that abstracts the implementation of [SurfaceControl.Builder] APIs depending on API
     * level
     */
    interface Builder {

        /**
         * Set a parent [Surface] from the provided [SurfaceView] for our new [SurfaceControlImpl].
         * Child surfaces are constrained to the onscreen region of their parent. Furthermore they
         * stack relatively in Z order, and inherit the transformation of the parent.
         *
        ...
        /**
         * Construct a new [SurfaceControlImpl] with the set parameters. The builder remains valid
         * after the [SurfaceControlImpl] instance is created.
         */
    ...
    interface Transaction : AutoCloseable {
        ...
        /**
         * Updates the [HardwareBuffer] displayed for the [SurfaceControlImpl]. Note that the buffer
         * must be allocated with [HardwareBuffer.USAGE_COMPOSER_OVERLAY] as well as
        ...
        /**
         * Set the Z-order for a given [SurfaceControlImpl], relative to its siblings. If two
         ...
         */
        fun setLayer(surfaceControl: SurfaceControlImpl, z: Int): Transaction
         ...
         */
        fun setDamageRegion(surfaceControl: SurfaceControlImpl, region: Region?): Transaction
         ...
         */
        fun setAlpha(surfaceControl: SurfaceControlImpl, alpha: Float): Transaction
         ...
         *
         * @param surfaceControl The [SurfaceControlImpl] to apply the crop to. This value cannot be
         *   null.
         ...
         */
        fun setCrop(surfaceControl: SurfaceControlImpl, crop: Rect?): Transaction

        /**
         * Sets the SurfaceControl to the specified position relative to the parent SurfaceControl
         *
         * @param surfaceControl The [SurfaceControlImpl] to change position. This value cannot be
         *   null
         * @param x the X position
         * @param y the Y position
         */
        fun setPosition(surfaceControl: SurfaceControlImpl, x: Float, y: Float): Transaction

        /**
         * Sets the SurfaceControl to the specified scale with (0, 0) as the center point of the
         * scale.
         *
         * @param surfaceControl The [SurfaceControlImpl] to change scale. This value cannot be
         *   null.
         * @param scaleX the X scale
         * @param scaleY the Y scale
         */
        fun setScale(surfaceControl: SurfaceControlImpl, scaleX: Float, scaleY: Float): Transaction
        ...
        fun setDataSpace(surfaceControl: SurfaceControlImpl, dataSpace: Int): Transaction
