...
object ComposeErrors {
    ...
    val COMPOSABLE_EXPECTED by error0<PsiElement>(SourceElementPositioningStrategies.DECLARATION_NAME)
    ...
    val COMPOSABLE_SUSPEND_FUN by error0<PsiElement>(SourceElementPositioningStrategies.DECLARATION_NAME)

    val COMPOSABLE_FUN_MAIN by error0<PsiElement>(SourceElementPositioningStrategies.DECLARATION_NAME)

    val COMPOSABLE_FUNCTION_REFERENCE by error0<PsiElement>()

    val COMPOSABLE_PROPERTY_BACKING_FIELD by error0<PsiElement>(SourceElementPositioningStrategies.DECLARATION_NAME)
