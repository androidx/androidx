 ...
 */
@Stable
public inline fun CornerRadius(x: Float, y: Float = x): CornerRadius =
...
public value class CornerRadius(public val packedValue: Long) {
    ...
    ): CornerRadius = CornerRadius(packFloats(x, y))
    ...
    @Stable
    public inline fun isCircular(): Boolean {
     ...
     */
    @Stable
    public inline operator fun unaryMinus(): CornerRadius =
        CornerRadius(packedValue xor DualFloatSignBit)
     ...
     */
    @Stable
    public operator fun minus(other: CornerRadius): CornerRadius {
        return CornerRadius(
            packFloats(
     ...
     */
    @Stable
    public operator fun plus(other: CornerRadius): CornerRadius {
        return CornerRadius(
            packFloats(
                unpackFloat1(packedValue) + unpackFloat1(other.packedValue),
                unpackFloat2(packedValue) + unpackFloat2(other.packedValue),
     ...
     */
    @Stable
    public operator fun times(operand: Float): CornerRadius =
        CornerRadius(
     ...
     */
    @Stable
    public operator fun div(operand: Float): CornerRadius =
        CornerRadius(
            packFloats(unpackFloat1(packedValue) / operand, unpackFloat2(packedValue) / operand)
        )
 ...
 */
@Stable
public fun lerp(start: CornerRadius, stop: CornerRadius, fraction: Float): CornerRadius {
    return CornerRadius(
        packFloats(
