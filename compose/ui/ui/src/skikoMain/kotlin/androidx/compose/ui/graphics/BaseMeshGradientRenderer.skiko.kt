 ...
 * allocations.
 */
// TODO: This is extracted sharable part with Android implementation. Move to commonMain
internal abstract class BaseMeshGradientRenderer : MeshGradientRenderer {
    ...
    /**
     * Draws the tessellated triangle mesh. This is the only part of the render pipeline that differs
     * between backends.
     *
