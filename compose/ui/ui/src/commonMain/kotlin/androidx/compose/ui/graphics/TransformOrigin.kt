 ...
 */
public fun TransformOrigin(pivotFractionX: Float, pivotFractionY: Float): TransformOrigin =
...
public value class TransformOrigin
internal constructor(@PublishedApi internal val packedValue: Long) {
    ...
    @Stable
    public inline operator fun component1(): Float = pivotFractionX

    @Suppress("NOTHING_TO_INLINE")
    @Stable
    public inline operator fun component2(): Float = pivotFractionY
    ...
    public companion object {
         ...
         */
        public val Center: TransformOrigin
