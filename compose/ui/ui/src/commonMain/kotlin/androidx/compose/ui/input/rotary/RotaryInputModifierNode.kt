 ...
 */
public interface RotaryInputModifierNode : DelegatableNode {
    /**
     ...
     */
    public fun onRotaryScrollEvent(event: RotaryScrollEvent): Boolean
     ...
     */
    public fun onPreRotaryScrollEvent(event: RotaryScrollEvent): Boolean
}
