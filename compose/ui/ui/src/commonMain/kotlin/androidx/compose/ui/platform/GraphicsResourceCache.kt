...
import androidx.compose.ui.graphics.vector.VectorDrawCacheKey
...
internal class GraphicsResourceCache {
    ...
    private val cache = MutableScatterMap<VectorDrawCacheKey, WeakReference<Any>>()

    private val maxSizeBeforeCleanup = 100

    /** Acquire a cached resource, creating it if necessary. */
    inline fun <T : Any> acquire(key: VectorDrawCacheKey, create: () -> T): T {
    ...
    fun contains(key: VectorDrawCacheKey): Boolean {
