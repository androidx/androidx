        ...
        try {
            ...
            val result =
                trace("AndroidOwner:onTouch") {
                    ...
                    if (lastEvent != null && lastEvent.action == ACTION_HOVER_EXIT) {
                        val previousEventDefaultPointerId = lastEvent.getPointerId(0)
                        ...
                        if (
                            ...
                            val previousX = lastEvent.x
                            val previousY = lastEvent.y
                            ...
                            val previousEventTime = lastEvent.eventTime
