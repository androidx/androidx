...
class ScrollCaptureTest {
    ...
    fun search_findsScrollableTarget() = captureTester.runTest {
        ...
        assertThat(target.positionInWindow).isEqualTo(coordinates.positionInWindow().roundToPoint())
    ...
    @Test
    fun search_doesNotFindTarget_whenHidingFromAccessibility() = captureTester.runTest {
        captureTester.setContent {
    ...
    @Test
    fun search_doesNotFindTarget_whenTransparent() = captureTester.runTest {
    ...
    fun callbackOnImageCapture_scrollsBackwardsThenForwards() = captureTester.runTest {
        expectingScrolls(rule) {
            ...
            captureTester.capture(target, captureWindowHeight = halfSize) {
                ...
                assertThat(performCaptureDiscardingBitmap()).isEqualTo(Rect(0, 0, size, halfSize))
