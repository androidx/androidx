...
class TextUnitTest {
    ...
    fun minus_unspecified() {
        assertFailsWith<RuntimeException> { -TextUnit.Unspecified }
    }
    ...
    fun multiply_unspecified_float() {
        assertFailsWith<RuntimeException> { TextUnit.Unspecified * 3f }
    }

    @Test
    fun multiply_unspecified_double() {
        assertFailsWith<RuntimeException> { TextUnit.Unspecified * 3.0 }
    }

    @Test
    fun multiply_unspecified_int() {
        assertFailsWith<RuntimeException> { TextUnit.Unspecified * 3 }
    }

    @Test
    fun multiply_float_unspecified() {
        assertFailsWith<RuntimeException> { 3f * TextUnit.Unspecified }
    }

    @Test
    fun multiply_double_unspecified() {
        assertFailsWith<RuntimeException> { 3.0f * TextUnit.Unspecified }
    }

    @Test
    fun multiply_int_unspecified() {
        assertFailsWith<RuntimeException> { 3 * TextUnit.Unspecified }
    }
    ...
    @Test
    fun compare_sp_em() {
        assertFailsWith<RuntimeException> { 1.sp > 2.em }
    }

    @Test
    fun compare_em_sp() {
        assertFailsWith<RuntimeException> { 1.em > 2.sp }
    }

    @Test
    fun compare_unspecified_sp() {
        assertFailsWith<RuntimeException> { TextUnit.Unspecified > 2.sp }
    }

    @Test
    fun compare_sp_unspecified() {
        assertFailsWith<RuntimeException> { 1.sp > TextUnit.Unspecified }
    }

    @Test
    fun compare_unspecified_em() {
        assertFailsWith<RuntimeException> { TextUnit.Unspecified > 2.em }
    }

    @Test
    fun compare_em_unspecified() {
        assertFailsWith<RuntimeException> { 1.em > TextUnit.Unspecified }
    }

    @Test
    fun compare_unspecified_unspecified() {
        assertFailsWith<RuntimeException> { TextUnit.Unspecified > TextUnit.Unspecified }
    }
