 ...
 * (b/171402426).
 *
 * Until then, it is recommended to use [androidx.compose.ui.input.pointer.pointerInput] to read
 * whether an event comes from a touch or mouse source. A more global way of determining this mode
 * will also be added as part of b/171402426.
 */
