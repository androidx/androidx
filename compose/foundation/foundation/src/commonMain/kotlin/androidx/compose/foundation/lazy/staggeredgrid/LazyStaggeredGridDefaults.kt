...
public object LazyStaggeredGridDefaults {
     ...
     *
     * @param state the [LazyStaggeredGridState] used to calculate the average visible item size
    ...
    public fun cacheWindow(state: LazyStaggeredGridState): LazyLayoutCacheWindow =
        remember(state) {
            DefaultLazyLayoutCacheWindow(
                ...
                ComposeFoundationFlags.isUsingDynamicDefaultCacheWindowInStaggeredGrids,
            )
        }
}
