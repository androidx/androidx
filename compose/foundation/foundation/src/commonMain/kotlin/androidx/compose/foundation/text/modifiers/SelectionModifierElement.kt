...
internal class SelectionModifierElement(
...
) : ModifierNodeElement<SelectionModifierNode>() {

    override fun create() =
        SelectionModifierNode(
            selectionRegistrar = selectionRegistrar,
            selectableId = selectableId,
            layoutCoordinatesProvider = layoutCoordinatesProvider,
        )

    override fun update(node: SelectionModifierNode) {
        node.update(
            selectionRegistrar = selectionRegistrar,
            selectableId = selectableId,
            layoutCoordinatesProvider = layoutCoordinatesProvider,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (other !is SelectionModifierElement) return false
