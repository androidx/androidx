...
internal fun Translations.uz() = mapOf(
    Strings.SelectAll to "Hammasini belgilash",
    Strings.Cut to "Kesib olish",
    Strings.Copy to "Nusxa olish",
    Strings.Paste to "Joylash",
    Strings.Autofill to "Avtomatik to‘ldirish",
)
