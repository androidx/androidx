...
internal fun Translations.de() = mapOf(
    ContextMenuStrings.SelectAll to "Alles auswählen",
    ContextMenuStrings.Cut to "Ausschneiden",
    ContextMenuStrings.Copy to "Kopieren",
    ContextMenuStrings.Paste to "Einfügen",
