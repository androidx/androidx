...
import androidx.compose.foundation.contextmenu.ContextMenuArea
 ...
 */
internal enum class TextContextMenuItems(val key: Any, val stringId: ContextMenuStrings, val drawableId: ContextMenuIcons) {
    Cut(
