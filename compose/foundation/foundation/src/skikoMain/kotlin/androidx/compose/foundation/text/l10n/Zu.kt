...
internal fun Translations.zu() = mapOf(
    Strings.SelectAll to "Khetha konke",
    Strings.Cut to "Nqamula",
    Strings.Copy to "Kopisha",
    Strings.Paste to "Namathisela",
    Strings.Autofill to "Ukugcwalisa ngokuzenzakalela",
)
