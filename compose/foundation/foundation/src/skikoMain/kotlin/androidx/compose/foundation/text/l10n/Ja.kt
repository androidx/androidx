...
internal fun Translations.ja() = mapOf(
    ContextMenuStrings.SelectAll to "すべて選択",
    ContextMenuStrings.Cut to "切り取り",
    ContextMenuStrings.Copy to "コピー",
    ContextMenuStrings.Paste to "貼り付け",
    ContextMenuStrings.Autofill to "自動入力",
)
