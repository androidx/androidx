...
@Composable
fun CarouselParallaxScrollEffectColumnDemo() {
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun FadingCarouselParallaxScrollEffectRowDemo() {
    data class CarouselItem(
        val id: Int,
        @DrawableRes val imageResId: Int,
        @StringRes val contentDescriptionResId: Int,
                    ...
                    ElevatedAssistChip(
                        modifier =
                            Modifier.padding(all = 14.dp).graphicsLayer {
                                val itemInfo = effectState.calculateItemInfo(i)
                                alpha = (1f - itemInfo.maskProgress * 2f).coerceIn(0f, 1f)
                                translationX = itemInfo.maskStart
                            },
                        onClick = { /* Do nothing */ },
                        label = { Text("Image $i") },
                        leadingIcon = {
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun CarouselParallaxScrollEffectHorizontalGridDemo() {
    data class CarouselItem(
        val id: Int,
        @DrawableRes val imageResId: Int,
        @StringRes val contentDescriptionResId: Int,
...
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun CarouselParallaxScrollEffectVerticalGridDemo() {
    data class CarouselItem(
        val id: Int,
        @DrawableRes val imageResId: Int,
        @StringRes val contentDescriptionResId: Int,
