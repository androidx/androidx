...
internal fun Translations.gu() = mapOf(
    ...
    Strings.ButtonGroupMoreOptions to "વધુ વિકલ્પો",
    ...
    Strings.FloatingToolbarMoreOptions to "વધુ વિકલ્પો",
    ...
    Strings.TimePickerToggleKeyboard to "ટેક્સ્ટ ઇનપુટ મોડ પર સ્વિચ કરો",
