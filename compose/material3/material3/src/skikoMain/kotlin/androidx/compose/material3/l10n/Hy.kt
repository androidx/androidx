...
internal fun Translations.hy() = mapOf(
    ...
    Strings.ButtonGroupMoreOptions to "Այլ ընտրանքներ",
    ...
    Strings.FloatingToolbarMoreOptions to "Այլ ընտրանքներ",
    ...
    Strings.TimePickerToggleKeyboard to "Անցնել տեքստի ներածման ռեժիմին",
