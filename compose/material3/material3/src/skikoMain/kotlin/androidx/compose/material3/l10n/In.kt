...
internal fun Translations.`in`() = mapOf(
    ...
    Strings.ButtonGroupMoreOptions to "Opsi lainnya",
    ...
    Strings.FloatingToolbarMoreOptions to "Opsi lainnya",
    ...
    Strings.TimePickerToggleKeyboard to "Beralih ke mode input teks",
