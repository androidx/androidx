...
internal fun Translations.ky() = mapOf(
    ...
    Strings.ButtonGroupMoreOptions to "Дагы параметрлер",
    ...
    Strings.FloatingToolbarMoreOptions to "Дагы параметрлер",
    ...
    Strings.TimePickerToggleKeyboard to "Текст киргизүү режимине которулуу",
