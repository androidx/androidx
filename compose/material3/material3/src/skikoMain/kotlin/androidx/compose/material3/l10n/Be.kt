...
internal fun Translations.be() = mapOf(
    ...
    Strings.ButtonGroupMoreOptions to "Дадатковыя параметры",
    ...
    Strings.FloatingToolbarMoreOptions to "Дадатковыя параметры",
    ...
    Strings.TimePickerToggleKeyboard to "Пераключыцца ў тэкставы рэжым уводу",
