...
internal fun Translations.bn() = mapOf(
    ...
    Strings.ButtonGroupMoreOptions to "আরও বিকল্প",
    ...
    Strings.FloatingToolbarMoreOptions to "আরও বিকল্প",
    ...
    Strings.TimePickerToggleKeyboard to "টেক্সট ইনপুট মোডে বদল করুন",
