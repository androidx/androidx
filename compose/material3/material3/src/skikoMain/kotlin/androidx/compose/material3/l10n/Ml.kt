...
internal fun Translations.ml() = mapOf(
    ...
    Strings.ButtonGroupMoreOptions to "കൂടുതൽ ഓപ്ഷനുകൾ",
    ...
    Strings.FloatingToolbarMoreOptions to "കൂടുതൽ ഓപ്ഷനുകൾ",
    ...
    Strings.TimePickerToggleKeyboard to "ടെക്‌സ്‌റ്റ് ഇൻപുട്ട് മോഡിലേക്ക് മാറുക",
