...
internal fun Translations.ms() = mapOf(
    ...
    Strings.ButtonGroupMoreOptions to "Lagi pilihan",
    ...
    Strings.FloatingToolbarMoreOptions to "Lagi pilihan",
    ...
    Strings.TimePickerToggleKeyboard to "Beralih kepada mod input teks",
