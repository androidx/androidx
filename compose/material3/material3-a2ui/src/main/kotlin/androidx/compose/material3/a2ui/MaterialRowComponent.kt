...
/**
 * A Jetpack Compose implementation of the A2UI `"Row"` component schema.
 *
 * Lays out A2UI children horizontally. Supports fixed child lists and dynamic child template.
 *
 * **Schema Properties:**
 * * `children` (ChildList, required): An array of component IDs or dynamic child template.
 */
public object MaterialRowComponent : A2uiComponent {
    ...
    override val description: String =
        "A layout component that arranges its children horizontally. To create a grid layout, " +
            "nest Columns within this Row."
