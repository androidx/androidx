...
class MaterialCardComponentTest {

    private val testCatalog =
        A2uiCatalog(catalogId = "test_catalog", components = listOf(MaterialCardComponent))

    @Test
    fun child_rendersChildComponent() = runComposeUiTest {
        val controller =
            A2uiTestController(
                catalog = testCatalog,
                initialComponents =
                    listOf(
                        A2uiComponentPayload(
                            id = "root",
                            type = "Card",
                            properties = mapOf("child" to "card_child"),
                        ),
                        A2uiComponentPayload(id = "card_child"),
                    ),
                componentStubs =
                    listOf(
                        A2uiComponentStub.withId("card_child") { _, modifier ->
                ...
                initialComponents =
                    listOf(
                        A2uiComponentPayload(
                            id = "root",
                            type = "Card",
                            properties = mapOf("child" to "failing_child"),
                        ),
    ...
    fun child_idChanges_rendersNewChildComponent() = runComposeUiTest {
                ...
                initialComponents =
                    listOf(
                        A2uiComponentPayload(
                            id = "root",
                            type = "Card",
                            properties = mapOf("child" to "child_1"),
                        ),
        ...
        controller.updateComponent(id = "root", properties = mapOf("child" to "child_2"))
        controller.waitForIdle()
                ...
                initialComponents =
                    listOf(
                        A2uiComponentPayload(
                            id = "root",
                            type = "Card",
                            properties = mapOf("child" to "delayed_text_id"),
                        ),
                ...
                initialComponents =
                    listOf(
                        A2uiComponentPayload(
                            id = "root",
                            type = "Card",
                            properties = mapOf("child" to "delayed_child"),
                        ),
                ...
                initialComponents =
                    listOf(
                        A2uiComponentPayload(
                            id = "root",
                            type = "Card",
                            properties = mapOf("child" to "child_id"),
                        ),
    ...
    fun modifier_parentModifier_isAppliedInAllChildStates() = runComposeUiTest {
                ...
                initialComponents =
                    listOf(
                        A2uiComponentPayload(
                            id = "root",
                            type = "Card",
                            properties = mapOf("child" to "stub_child"),
                        ),
        ...
        setContent {
            MaterialTheme {
                A2uiTestSurface(surface = surface, modifier = Modifier.testTag("card_tag"))
            }
        }
