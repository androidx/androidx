...
internal fun OperationArgContainer.getLong(
    highBitsParam: IntParameter,
    lowBitsParam: IntParameter,
): Long {
    val lowBits = getInt(lowBitsParam)
    val highBits = getInt(highBitsParam)
    return (highBits.toLong() shl Int.SIZE_BITS) or (lowBits.toLong() and 0xFFFFFFFF)
}
