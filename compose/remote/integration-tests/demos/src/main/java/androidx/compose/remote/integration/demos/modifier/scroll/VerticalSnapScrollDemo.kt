...
@Composable
fun VerticalSnapScrollDemo() {
    RemoteDemo(modifier = Modifier.fillMaxSize()) { VerticalSnapScrollDemoContent() }
}
...
@Composable
@RemoteComposable
private fun VerticalSnapScrollDemoContent() {
    ...
    RemoteColumn(
        modifier = RemoteModifier.verticalScroll(scrollState).fillMaxWidth().fillMaxHeight()
    ) {
