...
/**
 * This is a modified copy of the Android framework's
 * {@code com.android.internal.widget.ExploreByTouchHelper}.
 * <p>
 * Key differences from the original:
 * <ul>
 *     <li>Package name changed to
 *     {@code androidx.compose.remote.integration.demos.accessibility.platform}.</li>
 *     <li>Added {@code @RequiresApi(api = 36)}.</li>
 *     <li>Added {@code @SuppressWarnings("deprecation")}.</li>
 *     <li>Uses {@code org.jspecify.annotations.NonNull} instead of
 *     {@code android.annotation.NonNull}.</li>
 *     <li>The constructor takes a {@link View} and stores it as {@code mView}. The original
 *     used a delegate pattern where the View was passed to methods.</li>
 *     <li>{@link #dispatchHoverEvent(MotionEvent)} no longer takes a {@link View} parameter.</li>
 *     <li>A {@code mContext} field is added to store the host view's context.</li>
 * </ul>
 */
@RequiresApi(api = 36)
@SuppressLint({"deprecation", "UnknownNullness"})
...
public abstract class ExploreByTouchHelper extends View.AccessibilityDelegate {
     ...
     * @param virtualViewId The virtual view id for the item for which to
     *                      construct a node.
     * @return An {@link android.view.accessibility.AccessibilityNodeInfo} populated with
     * information
