...
/** Atomic demo for the onClick modifier. Demonstrates a tap interaction. */
@Suppress("RestrictedApiAndroidX")
fun DemoModifierOnClick(): RemoteComposeWriter {
    return RemoteComposeContextAndroid(
            width = 500,
            height = 500,
            contentDescription = "DemoModifierOnClick",
            apiLevel = 7,
            ...
            root {
                ...
                // Toggle state between 0 and 1 on click
