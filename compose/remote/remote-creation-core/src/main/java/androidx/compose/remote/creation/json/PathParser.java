...
/** String Parsing  manages the path buffer. */
@RestrictTo(RestrictTo.Scope.LIBRARY_GROUP)
public class PathParser implements RcPlatformServices.RcPathArrayCreator {
    ...
    public PathParser(int bufferSize) {
        mMaxSize = bufferSize;
    ...
    @RestrictTo(RestrictTo.Scope.LIBRARY_GROUP)
    public PathParser(@NonNull String pathData) {
        mPath = new float[mMaxSize];
