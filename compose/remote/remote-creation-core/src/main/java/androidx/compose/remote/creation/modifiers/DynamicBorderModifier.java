...
public class DynamicBorderModifier implements RecordingModifier.Element {
    float mWidth;
     ...
     * @param colorId int color
     * @param shape Shape.RECTANGLE/CIRCLE/ROUNDED_RECTANGLE
     */
    public DynamicBorderModifier(float width, float roundedCorner, short colorId, int shape) {
        mWidth = width;
    ...
    public void write(@NonNull RemoteComposeWriter writer) {
        writer.addModifierDynamicBorder(mWidth, mRoundedCorner, mColorId, mShapeType);
    }
}
