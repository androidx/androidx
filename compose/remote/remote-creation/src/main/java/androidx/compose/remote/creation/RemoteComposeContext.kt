...
/** Public API to create a new RemoteCompose byte array */
public class RemoteComposeContext {
    ...
    public constructor(
        ...
        height: Int,
        contentDescription: String,
        platform: Platform = AndroidxPlatformServices(),
        content: RemoteComposeContext.() -> Unit,
    ) {
    ...
    public constructor(
        ...
        mRemoteWriter = RemoteComposeWriter(AndroidxPlatformServices(), *tags)
        content()
    }
    ...
    public constructor(
        ...
        mRemoteWriter =
            RemoteComposeWriter(AndroidxPlatformServices(), CoreDocument.DOCUMENT_API_LEVEL, *tags)
        content()
    }
    ...
    public fun header(
        ...
        mRemoteWriter = RemoteComposeWriter.obtain(width, height, description, Profile.ANDROIDX)
    ...
    public fun addMatrixConst(m: android.graphics.Matrix): Float {
        return mRemoteWriter.addMatrixConst(m)
    }
