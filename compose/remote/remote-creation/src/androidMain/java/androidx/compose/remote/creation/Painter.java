...
public class Painter {
     ...
     *
     * @param startX The x-coordinate of the center of the starting circle, often referred to as the
     *     focal point.
     * @param startY The y-coordinate of the center of the starting circle, often referred to as the
     *     focal point.
     * @param startRadius The radius of the starting circle, often referred to as the focal radius.
     ...
     * @param positions May be <code>null</code>. Valid values are between <code>0.0f</code> and
     *     <code>1.0f</code>. The relative position of each corresponding color in the colors array.
     *     If <code>null</code>, colors are distributed evenly between the start and end circle.
     * @param tileMode The Shader tiling mode
     */
    public @NonNull Painter setRadialGradient(
            float startX,
    ...
    /**
     * sets a fallback typeface (0,1,2,3) object that best matches the specified existing typeface
     * and the specified weight and italic style if your custom font fails it should call this.
     *
     * @param fontType 0 = default 1 = sans serif 2 = serif 3 = monospace
     * @param weight The desired weight to be drawn.
