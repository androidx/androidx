...
public class IntegerExpressionEvaluator {
    ...
    int @NonNull [] mStack = new int[0];
    int @NonNull [] mLocalStack = new int[128];
    int @NonNull [] mVar = new int[0];
     ...
     */
    public int eval(int mask, int @NonNull [] exp, int @NonNull ... var) {
        mStack = exp;
        mVar = var;
        int sp = -1;
     ...
     * @return return the results of evaluating the expression
     */
    public int eval(int mask, int @NonNull [] exp, int len, int @NonNull ... var) {
     ...
     * @return return the results of evaluating the expression
     */
    public int evalDB(int opMask, int @NonNull [] exp, int @NonNull ... var) {
        mStack = exp;
        mVar = var;
        int sp = -1;
     ...
     */
    @NonNull
    public static String toString(int opMask, int @NonNull [] exp) {
        StringBuilder s = new StringBuilder();
     ...
     */
    @NonNull
    public static String toStringInfix(int opMask, int @NonNull [] exp) {
