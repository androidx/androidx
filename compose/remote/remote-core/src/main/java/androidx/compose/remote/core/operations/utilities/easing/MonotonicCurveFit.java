...
public class MonotonicCurveFit {
    ...
    private final double @NonNull [][] mY;
    private final double @NonNull [][] mTangent;
    private boolean mExtrapolate = true;
    final double @NonNull [] mSlopeTemp;
     ...
     */
    public MonotonicCurveFit(double @NonNull [] time, double @NonNull [][] y) {
     ...
     */
    public void getPos(double t, double @NonNull [] v) {
     ...
     */
    public void getPos(double t, float @NonNull [] v) {
        final int n = mT.length;
        final int dim = mY[0].length;
        if (mExtrapolate) {
            if (t <= mT[0]) {
     ...
     * @param v the array to fill
     */
    public void getSlope(double t, double @NonNull [] v) {
        final int n = mT.length;
        int dim = mY[0].length;
        if (t <= mT[0]) {
            t = mT[0];
     ...
     */
    public double @NonNull [] getTimePoints() {
        return mT;
    }
    ...
    @NonNull
    private static MonotonicCurveFit buildWave(double @NonNull [] values) {
