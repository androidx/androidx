...
/** Interface representing components capable of handling dispatched [Event]s. */
@RestrictTo(RestrictTo.Scope.LIBRARY_GROUP)
public interface EventHandler {
    /**
     * Checks if the handler supports the specified event type.
     *
     * @param eventType the event type to check
     * @return true if the event type is supported, false otherwise
     */
    boolean matchesEvent(int eventType);
     ...
     * @return integer status code resulting from handling the event
     */
    int onEvent(
