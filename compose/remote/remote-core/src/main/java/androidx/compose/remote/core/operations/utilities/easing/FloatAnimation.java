...
public class FloatAnimation extends Easing implements Serializable {
     ...
     * @param description the float encoding of the animation
     */
    public void setAnimationDescription(float @NonNull [] description) {
        mSpec = description;
    ...
    private void create(int type, float @Nullable [] params, int offset, int len) {
        switch (type) {
            case CUBIC_STANDARD:
            case CUBIC_ACCELERATE:
            case CUBIC_DECELERATE:
