...
public class AnimatedFloatExpression {
     ...
     */
    public float eval(
            @NonNull CollectionsAccess ca, float @NonNull [] exp, int len, float @NonNull ... var) {
     ...
     * @return the value the expression evaluated to
     */
    public float eval(@NonNull CollectionsAccess ca, float @NonNull [] exp, int len) {
        System.arraycopy(exp, 0, mLocalStack, 0, len);
        mStack = mLocalStack;
        mCollectionsAccess = ca;
        int sp = -1;
    ...
    static final int[] NO_OF_OPS = {
            ...
            2, 2, 1, 2 // a_sum_till, a_sum_xy, a_sum_sqr, a_lerp
    };
        ...
        switch (id) {
            ...
            case OP_A_LERP:
                ...
                if (index_lerp < 0) {
                    ...
                    mStack[sp - 1] = array[index_lerp] + t_lerp * (array[index_lerp + 1]
                            - array[index_lerp]);
                }
                return sp - 1;
        }
