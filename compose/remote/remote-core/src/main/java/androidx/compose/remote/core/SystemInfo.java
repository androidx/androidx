...
import static androidx.compose.remote.core.CoreDocument.DOCUMENT_API_LEVEL;
import static androidx.compose.remote.core.CoreDocument.PROFILE;
...
public class SystemInfo {
     ...
     *
     * @return the library api level
     */
    public int getLibraryApiLevel() {
        return mLibraryApiLevel;
    }

    /**
     * the Profile this reader is assuming
     *
     * @return the Profile this reader is assuming
     */
