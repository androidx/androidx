...
public class FloatToStringTest {
    ...
    public void testOptionFlags() {
        ...
        assertEquals(
                "7.1200",
                StringUtils.floatToString(
                        7.12f, 1, 4, ' ', '0', SEPARATOR_COMMA_PERIOD, GROUPING_BY3, NO_OPTIONS));
        assertEquals(
                "7.12",
                StringUtils.floatToString(
                        7.12f,
        ...
        assertEquals(
                "     123.45",
                StringUtils.floatToString(
                        123.45f, 8, 2, ' ', '0', SEPARATOR_COMMA_PERIOD, GROUPING_BY3, NO_OPTIONS));
        assertEquals(
                "00000123.45",
                StringUtils.floatToString(
                        123.45f,
        ...
        System.out.println(
                "   Options: PAD_PRE_SPACE | PAD_AFTER_ZERO | "
