...
/** [IssueRegistry] containing Remote Compose specific lint issues. */
class RemoteIssueRegistry : IssueRegistry() {
    // Tests are run with this version.
    override val api = 16
    ...
    override val vendor =
        Vendor(
            ...
            identifier = "androidx.compose.remote",
