...
object TextFieldDefaults {
     ...
     * if you build your custom text field using [TextFieldDecorationBox]. The [TextField] component
     * applies it automatically.
     *
     * @param enabled whether the text field is enabled.
     * @param isError whether the text field's current value is in error.
     * @param interactionSource the [InteractionSource] of this text field. Used to determine if the
     ...
     *   text style uses [Typography.caption] when the label is minimized and [Typography.subtitle1]
