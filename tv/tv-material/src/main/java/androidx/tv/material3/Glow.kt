 ...
 */
@Immutable
public class Glow(public val elevationColor: Color, public val elevation: Dp) {
    ...
    public fun copy(glowColor: Color? = null, glowElevation: Dp? = null): Glow =
        Glow(
    ...
    public companion object {
         ...
         */
        public val None: Glow = Glow(elevationColor = Color.Transparent, elevation = 0.dp)
    }
}
