...
public actual fun <T : RoomDatabase> findDatabaseConstructorAndInitDatabaseImpl(
    klass: KClass<*>
): T {
    val constructor = klass.findAssociatedObject<ConstructedBy>() as? RoomDatabaseConstructor<*>
    checkNotNull(constructor) {
        "Cannot find the associated ${RoomDatabaseConstructor::class.simpleName} for " +
            "${klass.simpleName}. Is Room annotation processor correctly configured?"
    }
