 ...
 *
 * The functions defined in this interface will be called on a background thread from the executor
...
public interface AutoMigrationSpec {
     ...
     */
    public suspend fun onPostMigrate(connection: SQLiteConnection) {}
}
