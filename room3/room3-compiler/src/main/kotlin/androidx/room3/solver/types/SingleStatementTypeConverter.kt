...
/** A [ColumnTypeConverter] that has only 1 statement (e.g. foo ? bar : baz). */
abstract class SingleStatementTypeConverter(from: XType, to: XType) :
    ColumnTypeConverter(from, to) {
