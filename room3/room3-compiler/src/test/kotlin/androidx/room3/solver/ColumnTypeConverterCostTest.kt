...
class ColumnTypeConverterCostTest {
    ...
    fun sections() {
        ...
        assertThat(cost.toString())
            .isEqualTo("Cost[upcast:7,nullsafe:3,converters:1,requireNotNull:2]")
    }

    @Test
    fun sum() {
        assertThat(Cost(converters = 3) + Cost(converters = 3, nullSafeWrapper = 4))
