...
class SchemaDifferTest {
    ...
    fun testColumnsAddedInOrder() {
        ...
        assertThat(schemaDiffResult.addedColumns[1].fieldBundle.columnName).isEqualTo("artistId")
    }
    ...
    fun testColumnAddedWithNoDefaultValue() {
        try {
            ...
            assertThat(ex.errorMessage)
                .isEqualTo(ProcessorErrors.newNotNullColumnMustHaveDefaultValue("artistId"))
        }
    }
    ...
    fun testTableRenamedWithoutAnnotation() {
        try {
            ...
            assertThat(ex.errorMessage)
                .isEqualTo(ProcessorErrors.deletedOrRenamedTableFound("MyAutoMigration", "Artist"))
        }
    }
    ...
    fun testRenameTwoColumnsOnComplexChangedTable() {
        ...
        schemaDiffResult.complexChangedTables.values.single().let { complexChange ->
            ...
            assertThat(complexChange.renamedColumnsMap)
                .containsExactlyEntriesIn(mapOf("songTitle" to "title", "songLength" to "length"))
        }
    }
    ...
    private val toColumnsAddedInOrder =
        SchemaBundle(
            2,
            DatabaseBundle(
                2,
    ...
    /** Adding multiple columns, preserving the order in which they have been added. */
    private val toColumnsAddedWithSameName =
        SchemaBundle(
            2,
            DatabaseBundle(
                2,
                ...
                listOf(
                    EntityBundle(
                        ...
                        listOf(
                            ...
                            FieldBundle("title", "title", "TEXT", true, ""),
                            FieldBundle("length", "length", "INTEGER", true, "1"),
                            FieldBundle("newColumn", "newColumn", "INTEGER", true, "0"),
                        ),
                        PrimaryKeyBundle(false, mutableListOf("id")),
                        emptyList(),
                        emptyList(),
    ...
    /**
     * If the user declared the default value in the SQL statement and not used a @ColumnInfo, Room
     * will put null for that default value in the exported schema. In this case we can't migrate.
     */
    private val toColumnAddedWithNoDefaultValue =
        SchemaBundle(
            2,
            DatabaseBundle(
                2,
