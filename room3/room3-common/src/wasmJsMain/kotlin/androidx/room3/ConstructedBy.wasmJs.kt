...
/**
 * Defines the [androidx.room3.RoomDatabaseConstructor] that will instantiate the Room generated
 * implementation of the annotated [Database].
 *
 * A [androidx.room3.RoomDatabase] database definition must be annotated with this annotation if it
 ...
 * object' that implements [androidx.room3.RoomDatabaseConstructor].
 *
 * Example usage:
 * ```
 ...
 * ```
 *
 * @see androidx.room3.RoomDatabaseConstructor
 */
...
public actual annotation class ConstructedBy(
     ...
     * [androidx.room3.RoomDatabaseConstructor] and is able to instantiate a
