 ...
 *
 * If `PrimaryKey` annotation is used on a [Embedded] field, all columns inherited from that
 * embedded field becomes the composite primary key (including its grand children fields).
 */
...
public annotation class PrimaryKey(
     ...
     *
     * If the field's type is [Int] or [Long] (or its TypeConverter converts it to an [Int] or
     * [Long]), [Insert] methods treat `null` as not-set while inserting the item.
     *
