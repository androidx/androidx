...
interface XPropertyElement : XVariableElement, XHasModifiers {
    /**
     * The element that declared this property. For property declared in classes, this will be an
     * [XTypeElement].
     *
     * For top level properties in Kotlin:
