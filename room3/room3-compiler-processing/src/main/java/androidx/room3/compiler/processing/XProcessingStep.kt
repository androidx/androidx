...
interface XProcessingStep {
     ...
     *
     * @return the elements (a subset of the values of [elementsByAnnotation]) that this step is
     *   unable to process, possibly until a later processing round. These elements will be passed
     *   back to this step at the next round of processing.
     */
    @Deprecated(
     ...
     *
     * Unlike [process], the elements in [elementsByAnnotation] are not validated and are those that
     * have been kept being deferred.
     *
