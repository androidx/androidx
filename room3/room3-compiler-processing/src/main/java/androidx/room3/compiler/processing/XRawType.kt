...
/**
 * It is common for processors to check certain types against known types. e.g. you may want to
 * check if an [XType] is a [List], or an [Iterable] or is assignable from an [Iterable].
 *
 * Kotlin does not model raw types, which makes it harder for our java compatibility. Instead, we
 * model them as [XRawType], a special purpose class.
 *
